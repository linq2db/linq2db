...
mono ./testrunner/NUnit.ConsoleRunner.3.5.0/tools/nunit3-console.exe Tests/Linq/bin/ReleaseMono/linq2db.Tests.dll --workers=1 --agents=1 --inprocess --where "cat != WindowsOnly"
