...
namespace LinqToDB
{
	...
	public class DataContextOptionsBuilder : IDataContextOptionsBuilderInfrastructure
	{
		...
		{
			return WithOption(e => e.WithReplacedService(typeof(TService), typeof(TImplementation)));
		}
		...
		{
			return WithOption(e => e.WithInterceptors(interceptors));
		}
		...
		/// <param name="interceptors"> The interceptors to add. </param>
		/// <returns> The same builder instance so that multiple calls can be chained. </returns>
		public DataContextOptionsBuilder AddInterceptors(params IInterceptor[] interceptors)
		{
		...
		public virtual DataContextOptionsBuilder WithOptions(Action<LinqOptionsBuilder> linqOptionsAction)
		{
			...
			linqOptionsAction(new LinqOptionsBuilder(this));
		...
		DataContextOptionsBuilder WithOption(Func<CoreDataContextOptionsExtension,CoreDataContextOptionsExtension> withFunc)
		{
