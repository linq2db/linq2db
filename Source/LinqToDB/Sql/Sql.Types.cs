	...
	public partial class Sql
	{
		public static class Types
		{
			...
			*/
			...
			/*class DecimalBuilder : IExtensionCallBuilder
			{
				public void Build(ISqExtensionBuilder builder)
				{
					var precision = builder.GetValue<int>("precision");
					var scale     = builder.GetValue<int>("scale");

					var sqlDataType = builder.Mapping.GetDbDataType(typeof(decimal));
					
					builder.ResultExpression = new SqlDataType(sqlDataType.WithPrecision(precision).WithScale(scale));
				}
			}

			[Extension("", BuilderType = typeof(DecimalBuilder))]*/
