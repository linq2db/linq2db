...
namespace LinqToDB
{
	...
	public static partial class Sql
	{
		...
		[Sql.Property  (PN.PostgreSQL, "now"                             , ServerSideOnly = true, CanBeNull = false)]
		[Sql.Expression(PN.DB2       , "CURRENT TIMESTAMP WITH TIME ZONE", ServerSideOnly = true, CanBeNull = false, Precedence = Precedence.Subtraction)]
		[Sql.Function  (PN.Oracle    , "SYSTIMESTAMP"                    , ServerSideOnly = true, CanBeNull = false, Precedence = Precedence.Additive)]
