...
namespace LinqToDB
{
	...
	public static partial class DataExtensions
	{
		...
		public static TempTable<T> CreateTempTable<T>(
			...
			Action<ITable<T>> action = null)
		{
			return new TempTable<T>(db, items, tableName, databaseName, schemaName, serverName, action);
		}
		...
		public static TempTable<T> CreateTempTable<T>(
			...
			Action<ITable<T>> action = null)
		{
			return new TempTable<T>(db, tableName, items, databaseName, schemaName, serverName, action);
		}
