...
namespace LinqToDB.Infrastructure
{
	...
	/// </para>
	/// </summary>
	public class DataContextOptionsExtensionOld : IDataContextOptionsExtension
	{
		...
		/// </summary>
		public DataContextOptionsExtensionOld()
		{
		}
		...
		protected DataContextOptionsExtensionOld(DataContextOptionsExtensionOld copyFrom)
		{
		...
		protected virtual DataContextOptionsExtensionOld Clone() => new DataContextOptionsExtensionOld(this);

		DataContextOptionsExtensionOld SetValue(Action<DataContextOptionsExtensionOld> setter)
		{
			var clone = Clone();
		...
		public virtual DataContextOptionsExtensionOld WithConnectionString(string? connectionString)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithConfigurationString(string? configurationString)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithConnection(DbConnection? connection)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithDisposeConnection(bool disposeConnection)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithProviderName(string? providerName)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithDataProvider(IDataProvider? dataProvider)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithMappingSchema(MappingSchema? mappingSchema)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithConnectionFactory(Func<DbConnection>? connectionFactory)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithTransaction(DbTransaction? transaction)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithTraceLevel(TraceLevel traceLevel)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WithTracing(Action<TraceInfo>? onTrace)
		{
		...
		/// <returns> A new instance with the option changed. </returns>
		public virtual DataContextOptionsExtensionOld WriteTraceWith(Action<string?, string?, TraceLevel>? write)
		{
		...
		sealed class ExtensionInfo : DataContextOptionsExtensionInfo
		{
			...
			public ExtensionInfo(DataContextOptionsExtensionOld extension)
				: base(extension)
			{
			}

			new DataContextOptionsExtensionOld Extension => (DataContextOptionsExtensionOld)base.Extension;
