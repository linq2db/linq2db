...
namespace LinqToDB.Internals.SqlQuery
{
	public class SqlFunction : SqlExpressionBase
	{
		...
		public static SqlFunction CreateAll   (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "ALL",    false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateSome  (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "SOME",   false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateAny   (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "ANY",    false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
