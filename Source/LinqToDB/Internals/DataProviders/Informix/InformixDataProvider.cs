...
using LinqToDB.Internals.DataProviders.Informix.Translation;
...
namespace LinqToDB.Internals.DataProviders.Informix
{
	...
	public abstract class InformixDataProvider : DynamicDataProviderBase<InformixProviderAdapter>
	{
		...
		protected override void SetParameterType(DataConnection dataConnection, DbParameter parameter, DbDataType dataType)
		{
			...
			/* Unmerged change from project 'LinqToDB (netstandard2.0)'
			Before:
						DB2.DB2ProviderAdapter.DB2Type?  db2Type = null;
			After:
						DB2ProviderAdapter.DB2Type?  db2Type = null;
			*/
			DB2.DB2ProviderAdapter.DB2Type?  db2Type = null;
			...
			switch (dataType.DataType)
			{
				...
				case DataType.NText:
					...
					Before:
										...
										break;
					After:
										db2Type = DB2ProviderAdapter .DB2Type.Clob;
										break;
					*/
					db2Type = DB2.DB2ProviderAdapter.DB2Type.Clob;
					break;
