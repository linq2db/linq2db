		...
		protected class DateFunctionsTranslator : DateFunctionsTranslatorBase
		{
			protected override ISqlExpression? TranslateDateTimeDatePart(ITranslationContext translationContext, TranslationFlags translationFlag, ISqlExpression dateTimeExpression, Sql.DateParts datepart)
			{
				...
				return datepart switch
				{
					...
					Sql.DateParts.Microsecond => factory.Mod(factory.Div(factory.Function(intDataType, "toUnixTimestamp64Nano", dateTimeExpression), 1000), 1000),
					Sql.DateParts.Tick        => factory.Mod(factory.Div(factory.Function(intDataType, "toUnixTimestamp64Nano", dateTimeExpression), 100), 100),
				    Sql.DateParts.Nanosecond  => factory.Mod(factory.Function(intDataType, "toUnixTimestamp64Nano", dateTimeExpression), 1000),
				    _                         => null,
				}
				;
			}
