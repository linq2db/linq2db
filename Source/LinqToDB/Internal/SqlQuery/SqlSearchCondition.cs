		...
		public override int Precedence
		{
			get
			{
				if (Predicates.Count == 0)
					return LinqToDB.SqlQuery.Precedence.Unknown;
				if (IsOr)
					return LinqToDB.SqlQuery.Precedence.LogicalDisjunction;
				
				return LinqToDB.SqlQuery.Precedence.LogicalConjunction;
			}
		}
