...
namespace LinqToDB.Internal.SqlQuery
{
	public class SqlFunction : SqlExpressionBase
	{
		public SqlFunction(DbDataType dbDataType, string name, params ISqlExpression[] parameters)
			: this(dbDataType, name, false, true, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}

		public SqlFunction(DbDataType dbDataType, string name, bool isAggregate, bool isPure, params ISqlExpression[] parameters)
			: this(dbDataType, name, isAggregate, isPure, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}

		public SqlFunction(DbDataType dbDataType, string name, bool isAggregate, params ISqlExpression[] parameters)
			: this(dbDataType, name, isAggregate, true, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}
		...
		public SqlFunction(Type systemType, string name, params ISqlExpression[] parameters)
			: this(systemType, name, false, true, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}

		public SqlFunction(Type systemType, string name, bool isAggregate, bool isPure, params ISqlExpression[] parameters)
			: this(systemType, name, isAggregate, isPure, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}

		public SqlFunction(Type systemType, string name, bool isAggregate, params ISqlExpression[] parameters)
			: this(systemType, name, isAggregate, true, LinqToDB.SqlQuery.Precedence.Primary, ParametersNullabilityType.IfAnyParameterNullable, null, parameters)
		{
		}
		...
		public static SqlFunction CreateCount(Type type, ISqlTableSource table)
		{
			return new SqlFunction(
				...
				canBeNull: null,
				new SqlExpression("*", new SqlValue(table.SourceID))
			);
		}

		public static SqlFunction CreateAll   (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "ALL",    isAggregate: false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateSome  (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "SOME",   isAggregate: false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateAny   (SelectQuery subQuery) { return new SqlFunction(typeof(bool), "ANY",    isAggregate: false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateExists(SelectQuery subQuery) { return new SqlFunction(typeof(bool), "EXISTS", isAggregate: false, LinqToDB.SqlQuery.Precedence.Comparison, subQuery); }
