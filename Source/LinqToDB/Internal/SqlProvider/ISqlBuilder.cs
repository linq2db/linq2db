...
namespace LinqToDB.Internal.SqlProvider
{
	...
	{
		void BuildSql(SqlStatement statement, StringBuilder sb, ISqlBuilderRenderContext renderContext, AliasesContext aliases, NullabilityContext? nullabilityContext,
			int           startIndent = 0);
		...
		/// <param name="escape">If <see langword="true"/>, apply required escaping to name components. Must be <see langword="true"/> except rare cases when escaping is not needed.</param>
