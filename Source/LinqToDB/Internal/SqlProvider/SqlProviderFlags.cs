...
namespace LinqToDB.Internal.SqlProvider
{
	...
	public sealed class SqlProviderFlags
	{
		...
		/// <summary>
		/// Indicates support of <c>ORDER BY</c> clause in UNION ALL.
		/// Default (set by <see cref="DataProviderBase"/>): <see langword="false"/>.
		/// </summary>
		[DataMember(Order = 16)]
		...
		/// Default: <see langword="false"/>.
		/// </summary>
		[DataMember(Order = 64), DefaultValue(false)]
		...
		/// </summary>
		[DataMember(Order = 81), DefaultValue(false)]
		...
		/// </summary>
		[DataMember(Order = 82), DefaultValue(false)]
		...
		/// <c>UNION ALL</c>.
		/// </summary>
		[DataMember(Order = 83), DefaultValue(false)]
