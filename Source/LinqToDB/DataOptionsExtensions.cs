...
namespace LinqToDB
{
	...
	public static partial class DataOptionsExtensions
	{
		...
		/// <summary>
		/// <para>
		/// Adds collection of <see cref="IUnaryTranslator" /> instances to those registered on the context.
		/// </para>
		/// </summary>
		[Pure]
		...
		/// <summary>
		/// <para>
		/// Adds collection of <see cref="IBinaryTranslator" /> instances to those registered on the context.
		/// </para>
		/// </summary>
		[Pure]
