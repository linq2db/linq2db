...
namespace LinqToDB
{
	...
	public static class ProviderName
	{
		...
		/// Used as configuration name for Access mapping schema <see cref="Internals.DataProviders.Access.AccessMappingSchema"/>.
		/// </summary>
		...
		/// <summary>
		/// Firebird provider.
		/// Used as configuration name for Firebird mapping schema <see cref="Internals.DataProviders.Firebird.FirebirdMappingSchema"/>.
		/// </summary>
		public const string Firebird      = "Firebird";
		/// <summary>
		/// Firebird 2.5 provider.
		/// Used as configuration name for Firebird mapping schema <see cref="Internals.DataProviders.Firebird.FirebirdMappingSchema.Firebird25MappingSchema"/>.
		/// </summary>
		public const string Firebird25      = "Firebird.2.5";
		/// <summary>
		/// Firebird 3 provider.
		/// Used as configuration name for Firebird mapping schema <see cref="Internals.DataProviders.Firebird.FirebirdMappingSchema.Firebird3MappingSchema"/>.
		/// </summary>
		public const string Firebird3      = "Firebird.3";
		/// <summary>
		/// Firebird 4 provider.
		/// Used as configuration name for Firebird mapping schema <see cref="Internals.DataProviders.Firebird.FirebirdMappingSchema.Firebird4MappingSchema"/>.
		/// </summary>
		public const string Firebird4      = "Firebird.4";
		/// <summary>
		/// Firebird 5 provider.
		/// Used as configuration name for Firebird mapping schema <see cref="Internals.DataProviders.Firebird.FirebirdMappingSchema.Firebird5MappingSchema"/>.
		/// </summary>
		public const string Firebird5      = "Firebird.5";
		/// <summary>
		/// Informix IBM.Data.Informix provider (including IDS provider).
		/// Used as configuration name for Informix mapping schema <see cref="Internals.DataProviders.Informix.InformixMappingSchema"/>.
		/// </summary>
		...
		/// Used as configuration name for Oracle base mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema"/>.
		/// </summary>
		public const string Oracle        = "Oracle";
		/// <summary>
		/// Oracle (11g dialect) ODP.NET native provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.Native11MappingSchema"/>.
		/// </summary>
		public const string Oracle11Native = "Oracle.11.Native";
		/// <summary>
		/// Oracle (11g dialect) Devart provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.Devart11MappingSchema"/>.
		/// </summary>
		public const string Oracle11Devart = "Oracle.11.Devart";
		/// <summary>
		/// Oracle (11g dialect) ODP.NET managed provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.Managed11MappingSchema"/>.
		/// </summary>
		public const string Oracle11Managed = "Oracle.11.Managed";
		/// <summary>
		/// Oracle ODP.NET native provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.NativeMappingSchema"/>.
		/// </summary>
		public const string OracleNative  = "Oracle.Native";
		/// <summary>
		/// Oracle ODP.NET managed provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.ManagedMappingSchema"/>.
		/// </summary>
		public const string OracleManaged = "Oracle.Managed";
		/// <summary>
		/// Oracle Devart provider.
		/// Used as configuration name for Oracle native provider mapping schema <see cref="Internals.DataProviders.Oracle.OracleMappingSchema.DevartMappingSchema"/>.
		/// </summary>
		public const string OracleDevart = "Oracle.Devart";
		/// <summary>
		/// PostgreSQL 9.2- data provider.
		/// Used as configuration name for PostgreSQL mapping schema <see cref="Internals.DataProviders.PostgreSQL.PostgreSQLMappingSchema"/>.
		/// </summary>
		...
		/// Used as configuration name for SQL CE mapping schema <see cref="Internals.DataProviders.SqlCe.SqlCeMappingSchema"/>.
		/// </summary>
		public const string SqlCe         = "SqlCe";
		/// <summary>
		/// SQLite provider.
		/// Used as configuration name for SQLite mapping schema <see cref="Internals.DataProviders.SQLite.SQLiteMappingSchema"/>.
		/// </summary>
		...
		/// Used as configuration name for Sybase ASE mapping schema <see cref="Internals.DataProviders.Sybase.SybaseMappingSchema.NativeMappingSchema"/>.
		/// </summary>
		...
		/// Used as configuration name for Sybase ASE mapping schema <see cref="Internals.DataProviders.Sybase.SybaseMappingSchema.ManagedMappingSchema"/>.
		/// </summary>
		public const string SybaseManaged = "Sybase.Managed";
		/// <summary>
		/// SAP HANA provider.
		/// Used as configuration name for SAP HANA mapping schema <see cref="Internals.DataProviders.SapHana.SapHanaMappingSchema"/>.
		/// </summary>
		public const string SapHana       = "SapHana";
		/// <summary>
		/// SAP HANA provider.
		/// Used as configuration name for SAP HANA mapping schema <see cref="Internals.DataProviders.SapHana.SapHanaMappingSchema.NativeMappingSchema"/>.
		/// </summary>
		public const string SapHanaNative = "SapHana.Native";
		/// <summary>
		/// SAP HANA ODBC provider.
		/// Used as configuration name for SAP HANA mapping schema <see cref="Internals.DataProviders.SapHana.SapHanaMappingSchema.OdbcMappingSchema"/>.
		/// </summary>
