...
namespace LinqToDB.Data
{
	public partial class DataConnection
	{
		...
		/// <summary>
		/// Gets or sets default connection settings. By default, contains settings from linq2db configuration section from configuration file in .NET Framework. For .NET support, look at linq2db.Compat package.
