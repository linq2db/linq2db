...
namespace LinqToDB
{
	...
	public enum TableOptions
	{
		...
		/// <para>Supported by: Oracle, PostgreSQL, SQLite, SQL Server, Sybase ASE.</para>
		/// </summary>
		IsTemporary       = 0b0010,
		/// <summary>
		/// Table is global temporary. This option will have effect only for databases that support temporary tables.
		/// <para>Supported by: Firebird, SQL Server, Sybase ASE.</para>
		/// </summary>
		...
		/// <para>Supported by: Firebird, PostgreSQL, SQLite.</para>
		/// </summary>
