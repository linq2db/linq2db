...
| Upsert — insert-or-update semantics (`InsertOrReplace`, `InsertOrUpdate`) | [`crud-merge-upsert.md`](crud-merge-upsert.md) |
| Bulk-insert many rows — `BulkCopy` | [`provider-capabilities.md`](provider-capabilities.md) — `Bulk Copy` column |
