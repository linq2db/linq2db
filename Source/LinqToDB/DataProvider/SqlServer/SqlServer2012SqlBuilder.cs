...
namespace LinqToDB.DataProvider.SqlServer
{
	...
	{
		public SqlServer2012SqlBuilder(IDataProvider? provider, MappingSchema mappingSchema, LinqOptions linqOptions, ISqlOptimizer sqlOptimizer, SqlProviderFlags sqlProviderFlags)
