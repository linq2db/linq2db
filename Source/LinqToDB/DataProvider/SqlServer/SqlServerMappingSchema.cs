...
namespace LinqToDB.DataProvider.SqlServer
{
	sealed class SqlServerMappingSchema : LockedMappingSchema
	{
		...
		public sealed class SqlServer2005MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2005 + SDS, new[] { Instance2005, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2005MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2005 + MDS, new[] { Instance2005, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2008MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2008 + SDS, new[] { Instance2008, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2008MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2008 + MDS, new[] { Instance2008, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2012MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2012 + SDS, new[] { Instance2012, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2012MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2012 + MDS, new[] { Instance2012, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2014MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2014 + SDS, new[] { Instance2014, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2014MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2014 + MDS, new[] { Instance2014, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2016MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2016 + SDS, new[] { Instance2016, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2016MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2016 + MDS, new[] { Instance2016, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2017MappingSchemaSystem   () : LockedMappingSchema(ProviderName.SqlServer2017 + SDS, new[] { Instance2017, SqlServerProviderAdapter.GetInstance(SqlServerProvider.SystemDataSqlClient   ).MappingSchema }.Where(ms => ms != null).ToArray()!);
		public sealed class SqlServer2017MappingSchemaMicrosoft() : LockedMappingSchema(ProviderName.SqlServer2017 + MDS, new[] { Instance2017, SqlServerProviderAdapter.GetInstance(SqlServerProvider.MicrosoftDataSqlClient).MappingSchema }.Where(ms => ms != null).ToArray()!);
