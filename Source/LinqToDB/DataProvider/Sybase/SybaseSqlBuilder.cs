...
namespace LinqToDB.DataProvider.Sybase
{
	...
	{
		public SybaseSqlBuilder(IDataProvider? provider, MappingSchema mappingSchema, LinqOptions linqOptions, ISqlOptimizer sqlOptimizer, SqlProviderFlags sqlProviderFlags)
