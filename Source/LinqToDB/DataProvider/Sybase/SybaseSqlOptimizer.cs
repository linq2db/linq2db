			...
			switch (func.Name)
			{
				...
				case "$Convert$":
				{
					...
					if (ftype == typeof(string))
					{
						...
						{
							return new SqlFunction(func.SystemType, "dateformat", func.Parameters[2], new SqlValue("YYYY-MM-DD HH24:MI:SS"));
						}
#if NET6_0_OR_GREATER
						else if (stype == typeof(DateOnly))
						{
							return new SqlFunction(func.SystemType, "dateformat", func.Parameters[2], new SqlValue("YYYY-MM-DD"));
						}
#endif
					}
