...
namespace LinqToDB.DataProvider.PostgreSQL
{
	...
	public static class PostgreSQLExtensions
	{
		...
		{
			return (dc, array) => dc.FromSql<T>($"UNNEST({array})");
		}
		...
		public static int ArrayPrepend<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T element, [ExprParameter] T[] array)
		{
		...
		public static int ArrayRemove<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T[] array, [ExprParameter] T element)
		{
		...
		public static int ArrayReplace<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T[] array, [ExprParameter] T oldElement, [ExprParameter] T newElement)
		{
		...
		public static int ArrayUpper<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T[] array, [ExprParameter] int dimension)
		{
		...
		[Sql.Extension("ARRAY_APPEND({array}, ({element})::text)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static string[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] string[] array, [ExprParameter] string element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}

		[Sql.Extension("ARRAY_APPEND({array}, ({element})::int)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static int[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] int[] array, [ExprParameter] int element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}

		[Sql.Extension("ARRAY_APPEND({array}, ({element})::bigint)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static long[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] long[] array, [ExprParameter] long element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}

		[Sql.Extension("ARRAY_APPEND({array}, ({element})::bigint)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static short[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] short[] array, [ExprParameter] short element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}

		[Sql.Extension("ARRAY_APPEND({array}, ({element})::double precision)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static double[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] double[] array, [ExprParameter] double element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}

		[Sql.Extension("ARRAY_APPEND({array}, ({element})::decimal)", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Primary)]
		public static decimal[] ArrayAppend(this IPostgreSQLExtensions? ext, [ExprParameter] decimal[] array, [ExprParameter] decimal element)
		{
			throw new LinqException($"'{nameof(ArrayAppend)}' is server-side method.");
		}
		...
		{
			return (dc, start, stop) => dc.FromSql<int>($"GENERATE_SERIES({start}, {stop})");
		}
		...
		{
			return (dc, start, stop, step) => dc.FromSql<int>($"GENERATE_SERIES({start}, {stop}, {step})");
		}
		...
		{
			return (dc, start, stop, step) => dc.FromSql<DateTime>($"GENERATE_SERIES({start}, {stop}, {step})");
		}
		...
		{
			return (dc, array, dimension) => dc.FromSql<int>($"GENERATE_SUBSCRIPTS({array}, {dimension})");
		}
		...
		{
			return (dc, array, dimension, reverse) => dc.FromSql<int>($"GENERATE_SUBSCRIPTS({array}, {dimension}, {reverse})");
		}
