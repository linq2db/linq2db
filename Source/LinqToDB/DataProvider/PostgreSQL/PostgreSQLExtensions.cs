...
namespace LinqToDB.DataProvider.PostgreSQL
{
	...
	public static class PostgreSQLExtensions
	{
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayAggregate)}' is server-side method.");
		}
		...
		public static IQueryable<T> Unnest<T>(this IDataContext dc, T[] array)
		{
			...
			throw new LinqToDBException($"'{nameof(Unnest)}' is server-side method.");
		}
		...
		{
			//TODO: can be executable when we finish queryable arrays
			throw new LinqToDBException($"'{nameof(UnnestWithOrdinality)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ConcatArrays)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(LessThan)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ContainedBy)}' is server-side method.");
		}

		[Sql.Extension("{array1} && {array2}", ServerSideOnly = true, CanBeNull = false, IsPredicate = true, Precedence = Precedence.Comparison)]
		public static bool Overlaps<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T[] array1, [ExprParameter] T[] array2)
		{
			throw new LinqToDBException($"'{nameof(Overlaps)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayAppend)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayCat)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayNDims)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayDims)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayLength)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayLower)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayPosition)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayPositions)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayPrepend)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayRemove)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayReplace)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayUpper)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(Cardinality)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ArrayToString)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(StringToArray)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ValueIsEqualToAny)}' is server-side method.");
		}

		[Sql.Extension("{value} < ANY({array})", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Comparison, IsPredicate = true)]
		public static bool ValueIsLessThanAny<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T value, [ExprParameter] T[] array)
		{
			throw new LinqToDBException($"'{nameof(ValueIsLessThanAny)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ValueIsLessThanOrEqualToAny)}' is server-side method.");
		}

		[Sql.Extension("{value} > ANY({array})", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Comparison, IsPredicate = true)]
		public static bool ValueIsGreaterThanAny<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T value, [ExprParameter] T[] array)
		{
			throw new LinqToDBException($"'{nameof(ValueIsGreaterThanAny)}' is server-side method.");
		}
		...
		{
			throw new LinqToDBException($"'{nameof(ValueIsGreaterThanOrEqualToAny)}' is server-side method.");
		}

		[Sql.Extension("{value} <> ANY({array})", ServerSideOnly = true, CanBeNull = true, Precedence = Precedence.Comparison, IsPredicate = true)]
		public static bool ValueIsNotEqualToAny<T>(this IPostgreSQLExtensions? ext, [ExprParameter] T value, [ExprParameter] T[] array)
		{
			throw new LinqToDBException($"'{nameof(ValueIsNotEqualToAny)}' is server-side method.");
		}
		...
		{
			//TODO: can be executable when we finish queryable arrays
			throw new LinqToDBException($"'{nameof(GenerateSubscripts)}' is server-side method.");
		}
