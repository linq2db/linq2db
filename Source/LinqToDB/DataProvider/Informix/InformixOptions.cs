...
namespace LinqToDB.DataProvider.Informix
{
	...
	/// Default bulk copy mode, used for Informix by <see cref="DataContextExtensions.BulkCopy{T}(IDataContext, IEnumerable{T})"/>
		...
		: DataProviderOptions<InformixOptions>(BulkCopyType)
	{
		...
		public bool Equals([NotNullWhen(true)] InformixOptions? other)
		{
