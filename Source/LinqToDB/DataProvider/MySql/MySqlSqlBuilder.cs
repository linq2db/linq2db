...
namespace LinqToDB.DataProvider.MySql
{
	...
	{
		public MySqlSqlBuilder(IDataProvider? provider, MappingSchema mappingSchema, LinqOptions linqOptions, ISqlOptimizer sqlOptimizer, SqlProviderFlags sqlProviderFlags)
