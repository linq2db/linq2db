...
namespace LinqToDB.DataProvider.Oracle
{
	public sealed class OracleMappingSchema : LockedMappingSchema
	{
		...
		OracleMappingSchema() : base(ProviderName.Oracle)
		{
			...
			SetDataType(typeof(string),  new DbDataType(typeof(string), DataType.VarChar, 255));
			SetDataType(typeof(decimal), new DbDataType(typeof(decimal), DataType.Decimal, 28, 10));
