...
namespace LinqToDB.Linq
{
	...
	public static class Expressions
	{
        ...
        static bool IsUserNamespace(String typeNamespace)
        {
            ...
            String root = dotIndex != -1 ? typeNamespace.Substring(0, dotIndex) : typeNamespace;
        ...
        static public Dictionary<string, Dictionary<MemberInfo, LambdaExpression>> Members
        {
            get
            {
                if (_members == null)
        ...
        static Dictionary<string, Dictionary<MemberInfo, LambdaExpression>> _members;
        static object _membersLock = new object();

        static Dictionary<string, Dictionary<MemberInfo, LambdaExpression>> LoadMembers()
        {
            return new Dictionary<string, Dictionary<MemberInfo, LambdaExpression>>
		    {
