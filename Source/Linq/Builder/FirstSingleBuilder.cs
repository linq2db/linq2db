...
namespace LinqToDB.Linq.Builder
{
	...
	class FirstSingleBuilder : MethodCallBuilder
	{
		...
		protected override IBuildContext BuildMethodCall(ExpressionBuilder builder, MethodCallExpression methodCall, BuildInfo buildInfo)
		{
			...
			if (!buildInfo.IsSubQuery || builder.DataContextInfo.DataContext.SqlProviderFlags.IsSubQueryTakeSupported)
		...
		public class FirstSingleContext : SequenceContextBase
		{
			...
			public override Expression BuildExpression(Expression expression, int level)
			{
				...
				{
					if (Builder.DataContextInfo.DataContext.SqlProviderFlags.IsApplyJoinSupported &&
