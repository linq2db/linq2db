        ...
        switch (func.Name) {
          case "Convert":
            ...
            if (func.Parameters[0] is SqlFunction) {
              ...
              return f.Name == "Char" ? new SqlFunction(func.SystemType, f.Name, func.Parameters[1]) : f.Parameters.Length == 1 ? new SqlFunction(func.SystemType, f.Name, func.Parameters[1], f.Parameters(0)) : new SqlFunction(func.SystemType, f.Name, func.Parameters[1], f.Parameters(0), f.Parameters(1));
            }
