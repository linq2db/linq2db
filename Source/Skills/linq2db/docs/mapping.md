...
| Need associations | `[Association]` or fluent `.Association(...)`; see [`associations.md`](associations.md) |
...
See [`associations.md`](associations.md) for relationship metadata, eager loading, and strategy markers.
