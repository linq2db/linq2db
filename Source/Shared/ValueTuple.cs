...
namespace System
{
	...
	/// </summary>
	internal interface IStructTupleInternal
	{
	...
	/// </summary>
	internal readonly struct ValueTuple
		: IEquatable<ValueTuple>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple>, IStructTupleInternal
	{
		/// <summary>
		...
		int IStructTupleInternal.GetHashCode(IEqualityComparer comparer)
		{
			return 0;
		}
		...
		string IStructTupleInternal.ToStringEnd()
		{
			return ")";
		}
		...
		/// </summary>
		int IStructTupleInternal.Size => 0;
	...
	internal struct ValueTuple<T1>
		: IEquatable<ValueTuple<T1>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1>>, IStructTupleInternal
	{
		/// <summary>
		...
		readonly int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1> objTuple)
				{
		...
		readonly int IStructTupleInternal.GetHashCode(IEqualityComparer comparer)
		{
			return comparer.GetHashCode(Item1!);
		}
		...
		readonly string IStructTupleInternal.ToStringEnd()
		{
			return Item1?.ToString() + ")";
		}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 1;
	}
	...
	internal struct ValueTuple<T1, T2>
		: IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2> objTuple)
				{
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 2;
	}
	...
	internal struct ValueTuple<T1, T2, T3>
		: IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 3;
	}
	...
	internal struct ValueTuple<T1, T2, T3, T4>
		: IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3, T4> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 4;
	}
	...
	internal struct ValueTuple<T1, T2, T3, T4, T5>
		: IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3, T4, T5> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 5;
	}
	...
	internal struct ValueTuple<T1, T2, T3, T4, T5, T6>
		: IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3, T4, T5, T6> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 6;
	}
	...
	internal struct ValueTuple<T1, T2, T3, T4, T5, T6, T7>
		: IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructTupleInternal
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3, T4, T5, T6, T7> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => 7;
	}
	...
	: IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IStructTupleInternal
	where TRest : struct
	{
		/// <summary>
		...
		int IComparable.CompareTo(object? obj)
		{
			if (obj is not null)
			{
				if (obj is ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> objTuple)
				{
					return CompareTo(objTuple);
				}
		...
		public readonly override int GetHashCode()
		{
			...
			int size = ((IStructTupleInternal)Rest).Size;
		...
		{
			// We want to have a limited hash in this case. We'll use the first 7 elements of the tuple
			if (Rest is not IStructTupleInternal rest)
			{
		...
		public readonly override string ToString()
		{
			if (Rest is IStructTupleInternal)
			{
				return "(" + Item1?.ToString() + ", " + Item2?.ToString() + ", " + Item3?.ToString() + ", " + Item4?.ToString() + ", " + Item5?.ToString() + ", " + Item6?.ToString() + ", " + Item7?.ToString() + ", " + ((IStructTupleInternal)Rest).ToStringEnd();
			}
		...
		/// The number of positions in this data structure.
		/// </summary>
		readonly int IStructTupleInternal.Size => Rest is IStructTupleInternal ? 7 + ((IStructTupleInternal)Rest).Size : 8;
	}
}
#pragma warning restore CA2201 // IndexOutOfRangeException reserved for runtime
#endif
