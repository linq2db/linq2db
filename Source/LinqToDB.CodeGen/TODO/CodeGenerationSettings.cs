...
namespace LinqToDB.CodeGen.CodeGeneration
{
	public class CodeGenerationSettings
	{
		...
		public NormalizationOptions ParameterNameNormalization { get; } = new() { Casing = NameCasing.CamelCase, Transformation = NameTransformation.SplitByUnderscore, Pluralization = Pluralization.None, DontCaseAllCaps = false };
		public NormalizationOptions SchemaClassNameNormalization { get; } = new() { Casing = NameCasing.Pascal, Transformation = NameTransformation.SplitByUnderscore, Pluralization = Pluralization.None, Suffix = "Schema" };
		public NormalizationOptions SchemaPropertyNormalization { get; } = new() { Casing = NameCasing.Pascal, Transformation = NameTransformation.SplitByUnderscore, Pluralization = Pluralization.None };
