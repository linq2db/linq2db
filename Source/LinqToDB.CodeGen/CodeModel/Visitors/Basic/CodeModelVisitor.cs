	...
	public abstract class CodeModelVisitor
	{
		...
		public void Visit(ICodeElement node)
		{
			...
			switch (node.ElementType)
			{
				...
				case CodeElementType.Call            : Visit((CodeCall           )node); break;
				...
				case CodeElementType.Assignment      : Visit((CodeAssignment     )node); break;
				...
				case CodeElementType.Throw           : Visit((CodeThrow          )node); break;
		...
		protected abstract void Visit(CodeThrow           expression);
		...
		protected abstract void Visit(CodeAssignment      expression);
		...
		protected abstract void Visit(CodeCall            call      );
