...
namespace LinqToDB.CodeGen.CodeGeneration
{
	public class CodeGenerationSettings
	{
		...
		public List<string> ConflictingNamespaces { get; } = new();

		// SqlHierarchyId returns SqlBoolean from operator== (－‸ლ)
		public List<(string typeName, bool isValueType)> NonBooleanEqualityTypes { get; } = new() { ("Microsoft.SqlServer.Types.SqlHierarchyId", true) };
	}
}
