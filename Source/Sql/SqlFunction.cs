...
namespace LinqToDB.Sql
{
	public class SqlFunction : ISqlExpression//ISqlTableSource
	{
		public SqlFunction(Type systemType, string name, params ISqlExpression[] parameters)
			: this(systemType, name, LinqToDB.Sql.Precedence.Primary, parameters)
		{
		}
		...
		public static SqlFunction CreateAll   (SqlQuery subQuery) { return new SqlFunction(typeof(bool), "ALL",    LinqToDB.Sql.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateSome  (SqlQuery subQuery) { return new SqlFunction(typeof(bool), "SOME",   LinqToDB.Sql.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateAny   (SqlQuery subQuery) { return new SqlFunction(typeof(bool), "ANY",    LinqToDB.Sql.Precedence.Comparison, subQuery); }
		public static SqlFunction CreateExists(SqlQuery subQuery) { return new SqlFunction(typeof(bool), "EXISTS", LinqToDB.Sql.Precedence.Comparison, subQuery); }
