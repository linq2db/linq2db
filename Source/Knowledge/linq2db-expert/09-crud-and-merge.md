...
| Update one entity with an optimistic lock column check | `db.UpdateOptimistic(entity)` - see [`concurrency.md`](09-crud-and-merge.md) |
...
- [`concurrency.md`](09-crud-and-merge.md) - optimistic concurrency for entity update/delete
- [`provider-capabilities.md`](07-provider-configuration.md) - `OUTPUT / RETURNING` support per provider
...
[`concurrency.md`](09-crud-and-merge.md).
...
<!-- Generated from: Source/Skills/linq2db/docs/concurrency.md -->
...
from [`crud/crud-update.md`](09-crud-and-merge.md) and explicitly include whatever concurrency
