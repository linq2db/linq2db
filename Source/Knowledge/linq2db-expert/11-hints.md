<!-- Generated from: Source/Skills/linq2db/docs/hints.md -->
...
2. Search [`docs/hints-api-map.md`](12-hints-api-map.md) by provider name and exact SQL hint text or
...
- [`docs/crud/crud-merge.md`](09-crud-and-merge.md) - MERGE builder and merge-specific hints.
- [`docs/hints-api-map.md`](12-hints-api-map.md) - reverse lookup from concrete provider SQL hint
  text to typed provider-specific helper APIs.
- [`docs/provider-capabilities.md`](07-provider-configuration.md) - provider feature support.
- [`docs/provider-setup.md`](07-provider-configuration.md) - provider selection, dialects, and driver packages.
- [`docs/custom-sql.md`](13-custom-sql.md) - custom SQL expressions when hints are not the right tool.
