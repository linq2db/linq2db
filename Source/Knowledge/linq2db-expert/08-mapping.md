<!-- Generated from: Source/Skills/linq2db/docs/mapping.md -->
...
- [`docs/architecture.md`](05-architecture.md) - mapping model and query translation overview.
- [`docs/agent-antipatterns.md`](06-agent-antipatterns-and-ai-tags.md) - `MappingSchema` lifetime and unconstrained column anti-patterns.
- [`docs/query-temp-tables.md`](10-query-composition.md) - temporary table mapping and DDL-sensitive schema rules.
- [`docs/configuration.md`](07-provider-configuration.md) - attaching `MappingSchema` to `DataOptions`.
