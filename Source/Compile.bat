...
%windir%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe LinqToDB.csproj /property:Configuration=Debug   /property:OutputPath=bin\Debug.4.0\   /property:TargetFrameworkVersion=v4.0
%windir%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe LinqToDB.csproj /property:Configuration=Release /property:OutputPath=bin\Release.4.0\ /property:TargetFrameworkVersion=v4.0
