...
namespace LinqToDB.Tools
{
	internal static class Program
	{
		...
		private static void BuildModel(string configName)
		{
			...
			codegenSettings.EntityInSeparateFile = true;
			...
			{
				var schemaProvider = new CodeGen.Schema.SchemaProvider(dc, schemaSettings, languageProvider.TypeParser);
				...
				var files = codeBuilder.ConvertToCodeModel(dataModel);
