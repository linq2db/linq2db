...
namespace LinqToDB.Scaffold
{
	public sealed class SchemaOptions
	{
		...
		/// <summary>
		/// When set to <see langword="true" />, will prefer generation of provider-specific types instead of general types in mappings (for columns and procedure/function parameters).
		/// <list type="bullet">
		...
		#region Tables/Views
		/// <summary>
		/// Delegate to filter loaded tables and views by database name (only name and schema provided). Returns <see langword="true" />, if table/view should be loaded.
		/// Second parameter (isView) in delegate provides <see langword="true" /> for view and <see langword="false"/> for table.
		/// <list type="bullet">
		...
		/// When <see langword="true" />, load only specified schemas, otherwise load all schemas except specififed in <see cref="Schemas"/>.
		/// <list type="bullet">
		/// <item>Default: <see langword="true" /></item>
		...
		/// </list>
		/// </summary>
		public ISet<string> Schemas { get; } = new HashSet<string>(StringComparer.Ordinal);
		/// <summary>
		...
		/// When <see langword="true" />, load only specified catalogs, otherwise all load catalogs except specififed in <see cref="Catalogs"/>.
		/// <list type="bullet">
		/// <item>Default: <see langword="true" /></item>
		/// <item>In T4 compability mode: <see langword="true" /></item>
		/// </list>
		...
		/// </list>
		/// </summary>
		public ISet<string> Catalogs { get; } = new HashSet<string>(StringComparer.Ordinal);
		#endregion

		#region Procedures/Functions
		/// <summary>
		/// Specify stored procedure or table function schema load mode.
		/// When <see langword="false"/>, procedure or function will be executed with <see cref="CommandBehavior.SchemaOnly"/> option.
		...
		/// <summary>
		/// Delegate to specify if schema should be loaded for procedure by procedure's database name (only name and schema provided). Returns <see langword="true" />, if procedure schema should be loaded.
		/// <list type="bullet">
		...
		/// <summary>
		/// Delegate to filter loaded stored procedured by database name (only name and schema provided). Returns <see langword="true" />, if stored procedure should be loaded.
		/// <list type="bullet">
		...
		/// <summary>
		/// Delegate to filter loaded table functions by database name (only name and schema provided). Returns <see langword="true" />, if table function should be loaded.
		/// <list type="bullet">
		...
		/// <summary>
		/// Delegate to filter loaded scalar functions by database name (only name and schema provided). Returns <see langword="true" />, if scalar function should be loaded.
		/// <list type="bullet">
		...
		/// <summary>
		/// Delegate to filter loaded aggregate functions by database name (only name and schema provided). Returns <see langword="true" />, if aggregate function should be loaded.
		/// <list type="bullet">
