...
- **`code-correctness`** — rules 1 (correctness, predicate broadening, equality/hash/wire-ordinal/AST-node propagation), 2 (thread safety), 3 (performance), 7 (style fit), 8 (scope creep), 10 (playground leaks), 11 (code duplication).
