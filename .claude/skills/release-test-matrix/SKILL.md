...
1. Build all linq2db nugets: ask user for the exact command. Typical: `dotnet pack linq2db.slnx -c Release -o .build/.claude/release-<ver>-nugets/`. Record on first run.
