...
```
pwsh -NoProfile -File .claude/scripts/analyzer-profile-build.ps1 -LogPath .build/.claude/analyzer-build.log
```
...
```
pwsh -NoProfile -File .claude/scripts/analyzer-profile-report.ps1 -LogPath .build/.claude/analyzer-build.log -Top 10
```
