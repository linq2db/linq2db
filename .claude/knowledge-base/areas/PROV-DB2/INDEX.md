...
| `DB2zOSSqlBuilder` | `Internal/DataProvider/DB2/DB2zOSSqlBuilder.cs` | z/OS override: `VARBINARY` max 32704 |
...
| `DB2MemberTranslator` | `Internal/DataProvider/DB2/Translation/DB2MemberTranslator.cs` | Date parts, date add/truncate, `LISTAGG`, `GREATEST`/`LEAST`, GUID-to-string via hex + substr |
...
`IsSqlValuesTableValueTypeRequired` forces a typed cast on the first row when an entire column contains only NULLs, to avoid DB2 `SQL0418N` (`untyped parameter marker`). `Source/LinqToDB/Internal/DataProvider/DB2/DB2SqlBuilderBase.Merge.cs:28`
...
- UTC timestamp: `CURRENT TIMESTAMP - CURRENT TIMEZONE`
...
| `Internal/DataProvider/DB2/DB2zOSSqlBuilder.cs` | z/OS dialect overrides |
| `Internal/DataProvider/DB2/DB2SqlExpressionConvertVisitor.cs` | Expression-level SQL conversions |
| `Internal/DataProvider/DB2/Translation/DB2MemberTranslator.cs` | LINQ member → SQL function translations |
...
- Tier 1 (visited / total): 11 / 11 ✓
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2DataProvider.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2SqlBuilderBase.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2SqlOptimizer.cs
  - Source/LinqToDB/DataProvider/DB2/DB2Tools.cs
  - Source/LinqToDB/DataProvider/DB2/DB2Version.cs
  - Source/LinqToDB/DataProvider/DB2/DB2Options.cs
  - Source/LinqToDB/DataProvider/DB2/DB2IdentifierQuoteMode.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2ProviderAdapter.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2ProviderDetector.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2MappingSchema.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2BulkCopy.cs
- Tier 2 (visited / total): 10 / 10 (100%) ✓
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2SqlBuilderBase.Merge.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2LUWSqlBuilder.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2zOSSqlBuilder.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2SqlExpressionConvertVisitor.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/Translation/DB2MemberTranslator.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2LUWSchemaProvider.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2zOSSchemaProvider.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2BulkCopyShared.cs
  - Source/LinqToDB/Internal/DataProvider/DB2/DB2Extensions.cs
  - Source/LinqToDB/DataProvider/DB2/DB2Factory.cs
