...
- **Date**: `DatePart("x", e)`, `DateAdd("x", n, e)`, `DateSerial(y,m,d)`, `Now` (no-arg function). Sub-second `MakeDateTime` not supported (returns `null`). `AccessMemberTranslator.cs:51–199`.
- **Math**: `Round` uses `IIF(Abs(v*10 Mod 10)=5 And Int(v) Mod 2=0, Int(v), Round(v))` for banker's rounding at precision 0; for non-zero precision falls back to base. `AccessMemberTranslator.cs:203–240`. `Pow` → `x ^ y` binary expression. `AccessMemberTranslator.cs:303–331`.
- **String**: `LPad` via `String(n, char) + value`; `Join` via `Mid`-based concat-with-separator emulation.
- **GUID**: `ToString()` → `LCase(Mid(CStr(g), 2, 36))`. `AccessMemberTranslator.cs:373–388`.
- **Aggregates**: `COUNT DISTINCT` and aggregation `DISTINCT` both unsupported. `AccessMemberTranslator.cs:391–394`.
...
- Tier 1 (visited / total): 11 / 11 ✓
  - Source/LinqToDB/Internal/DataProvider/Access/AccessDataProvider.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSqlBuilderBase.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSqlOptimizer.cs
  - Source/LinqToDB/DataProvider/Access/AccessTools.cs
  - Source/LinqToDB/DataProvider/Access/AccessVersion.cs
  - Source/LinqToDB/DataProvider/Access/AccessProvider.cs
  - Source/LinqToDB/DataProvider/Access/AccessOptions.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessProviderAdapter.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessProviderDetector.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessMappingSchema.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessBulkCopy.cs
- Tier 2 (visited / total): 16 / 16 (100%) ✓
  - Source/LinqToDB/Internal/DataProvider/Access/AccessOleDbSqlBuilder.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessODBCSqlBuilder.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSqlExpressionConvertVisitor.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessDmlService.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSchemaProviderBase.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessOleDbSchemaProvider.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessODBCSchemaProvider.cs
  - Source/LinqToDB/Internal/DataProvider/Access/Translation/AccessMemberTranslator.cs
  - Source/LinqToDB/Internal/DataProvider/Access/Translation/AccessJetMemberTranslator.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSpecificQueryable.cs
  - Source/LinqToDB/Internal/DataProvider/Access/AccessSpecificTable.cs
  - Source/LinqToDB/DataProvider/Access/AccessHints.cs
  - Source/LinqToDB/DataProvider/Access/AccessSpecificExtensions.cs
  - Source/LinqToDB/DataProvider/Access/IAccessSpecificQueryable.cs
  - Source/LinqToDB/DataProvider/Access/IAccessSpecificTable.cs
  - Source/LinqToDB/DataProvider/Access/AccessFactory.cs
