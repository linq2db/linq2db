...
`FirebirdDataProvider.CreateSqlBuilder` dispatch (`FirebirdDataProvider.cs:100–107`):
...
`FirebirdDataProvider.GetSqlOptimizer` (`FirebirdDataProvider.cs:111–113`): `v3+` → `Firebird3SqlOptimizer`; `v25` → `FirebirdSqlOptimizer`.

`FirebirdDataProvider.CreateMemberTranslator` (`FirebirdDataProvider.cs:90–93`): `v5` → `Firebird5MemberTranslator`; else → `FirebirdMemberTranslator`.

`CreateIdentifierService` (`FirebirdDataProvider.cs:95–98`): max identifier length = 31 chars for `v3` and below; 63 chars for `v4+`.
...
ProviderMemberTranslatorDefault
  └── FirebirdMemberTranslator    (all versions)
...
- `TranslateDateTimeTruncationToDate`: `CAST(… AS DATE)`.
...
`FirebirdDataProvider.SetParameterType` (`FirebirdDataProvider.cs:138–166`):
...
| `Internal/DataProvider/Firebird/Translation/FirebirdMemberTranslator.cs` | Date/string/Guid member translations; `LIST` aggregate; `Gen_Uuid`; `DateAdd` non-parameter constraint |
| `Internal/DataProvider/Firebird/Translation/Firebird5MemberTranslator.cs` | Native `QUARTER` extract; `LIST DISTINCT` support |
...
- Tier 1 (visited / total): 11 / 11 ✓
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdDataProvider.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdSqlBuilder.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdSqlOptimizer.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdTools.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdVersion.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdOptions.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdIdentifierQuoteMode.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdProviderAdapter.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdProviderDetector.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdMappingSchema.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdBulkCopy.cs`
- Tier 2 (visited / total): 12 / 12 (100%) ✓
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Firebird3SqlBuilder.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Firebird4SqlBuilder.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Firebird3SqlOptimizer.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdSqlBuilder.Merge.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdSqlExpressionConvertVisitor.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Firebird3SqlExpressionConvertVisitor.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Translation/FirebirdMemberTranslator.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/Translation/Firebird5MemberTranslator.cs`
  - `Source/LinqToDB/Internal/DataProvider/Firebird/FirebirdSchemaProvider.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdExtensions.cs`
  - `Source/LinqToDB/DataProvider/Firebird/FirebirdFactory.cs`
  - `Source/LinqToDB/DataProvider/Firebird/IFirebirdExtensions.cs`
