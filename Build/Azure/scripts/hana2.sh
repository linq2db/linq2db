...
docker run -h hxehost -d --name hana2 -p 39017:39017 -m 4294967296 saplabs/hanaexpress:2.00.072.00.20231123.1 --agree-to-sap-license --passwords-url file:///hana/password.json
