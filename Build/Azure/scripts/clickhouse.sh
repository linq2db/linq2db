...
# network_compression_method - 26.9 defaults it to ZSTD(3), which Octonica.ClickHouseClient cannot
# read (LZ4 only). Drop once Octonica/ClickHouseClient#114 ships.
