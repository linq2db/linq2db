docker run -d --name pgsql -e POSTGRES_PASSWORD=Password12! -p 5432:5432 dominiquesavoie/postgres:windows-latest
docker ps -a
...
sleep 1
docker exec docker exec pgsql psql -U postgres -c "\l"
set /a max=max-1
