...
- [Move Linq expression translation to dedicated namespace](../../history/decisions/2012-move-linq-namespace.md)

## Test coverage

- [TESTS-LINQ INDEX](../TESTS-LINQ/INDEX.md) — primary validator
