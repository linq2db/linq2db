...
Tests/Linq/AssemblyInfo.TestProgress.cs -- **(new)** assembly-level [assembly: TestProgressReporter] attribute. Opt-in via the LINQ2DB_TEST_PROGRESS environment variable; provides a live heartbeat for long test runs. See .agents/docs/testing.md for monitoring details.
