...
- The `category` parameter in `LinqToDBLoggerFactoryAdapter.OnTrace` is unused (`IDE0060` suppressed). Category-per-logger routing is deferred. (`Logging/LinqToDbLoggerFactoryAdapter.cs:14`)
