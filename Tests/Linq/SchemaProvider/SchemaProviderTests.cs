...
namespace Tests.SchemaProvider
{
	...
	public class SchemaProviderTests : TestBase
	{
		...
		[Test]
		public void Test([DataSources(false, ProviderName.SQLiteMS, TestProvName.AllOracle12)] string context)
		{
		...
		[Test]
		public void PrimaryForeignKeyTest([DataSources(false, ProviderName.SQLiteMS, TestProvName.AllOracle12, ProviderName.AccessOdbc)]
			string context)
		{
			using (var db = GetDataConnection(context))
			{
