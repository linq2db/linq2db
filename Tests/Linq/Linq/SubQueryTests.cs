...
namespace Tests.Linq
{
	...
	public class SubQueryTests : TestBase
	{
		...
		[Test, DataContextSource(ProviderName.Informix, ProviderName.MySql, ProviderName.Sybase, ProviderName.SybaseManaged, ProviderName.SybaseManaged, ProviderName.SapHana, ProviderName.Access, ProviderName.Oracle, ProviderName.OracleManaged, ProviderName.OracleNative,
		...
		[Test, DataContextSource(
			...
			TestProvName.MariaDB, TestProvName.MySql57, ProviderName.SqlServer2000, ProviderName.Sybase, ProviderName.SybaseManaged, ProviderName.SybaseManaged, ProviderName.Informix, ProviderName.SapHana)]
