...
namespace Tests.Linq
{
	...
	public class DateTimeOffsetTests : TestBase
	{
		...
		[Test]
		public void GroupByDateTimeOffsetByDateTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
		...
		[Test]
		public void GroupByDateTimeOffsetByTimeOfDayTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByDayTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByDayOfWeekTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByDayOfYearTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByHourTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByLocalDateTimeTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByMillisecondTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByMinuteTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByMonthTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetBySecondTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByYearTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddDaysTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddHoursTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddMillisecondsTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddMinutesTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddMonthsTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddSecondsTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void GroupByDateTimeOffsetByAddYearsTest([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			{
				using (db.CreateLocalTable(Transaction.Data))
		...
		[Test]
		public void DateAddYear([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddQuarter([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddMonth([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddDayOfYear([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddDay([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddWeek([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddWeekDay([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddHour([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddMinute([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddSecond([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddYears([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddMonths([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddDays([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddHours([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddMinutes([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void AddSeconds([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			using (var db = GetDataContext(context))
			using (db.CreateLocalTable(Transaction.Data))
				AreEqual(
		...
		[Test]
		public void DateAddYearExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 6;
			var part2 = 5;
		...
		[Test]
		public void DateAddQuarterExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 6;
			var part2 = 5;
		...
		[Test]
		public void DateAddMonthExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 5;
			var part2 = 3;
		...
		[Test]
		public void DateAddDayOfYearExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 6;
			var part2 = 3;
		...
		[Test]
		public void DateAddDayExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void DateAddWeekExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void DateAddWeekDayExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void DateAddHourExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void DateAddMinuteExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void DateAddSecondExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 20;
			var part2 = 21;
		...
		[Test]
		public void AddYearsExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 5;
			var part2 = 4;
		...
		[Test]
		public void AddMonthsExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 4;
		...
		[Test]
		public void AddDaysExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 2;
			var part2 = 3;
		...
		[Test]
		public void AddHoursExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 11;
			var part2 = 11;
		...
		[Test]
		public void AddMinutesExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 1;
			var part2 = 9;
		...
		[Test]
		public void AddSecondsExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)] string context)
		{
			var part1 = 5;
			var part2 = 40;
		...
		[Test]
		public void AddMillisecondsExpression([IncludeDataSources(TestProvName.AllSqlServer2008Plus, TestProvName.AllOracle, TestProvName.AllPostgreSQL10Plus)]
			string context)
		{
			var part1 = 150;
			var part2 = 76;
