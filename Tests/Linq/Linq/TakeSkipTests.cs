...
namespace Tests.Linq
{
	...
	public class TakeSkipTests : TestBase
	{
		...
		[ActiveIssueNew("https://github.com/ydb-platform/ydb/issues/46197", Configuration = TestProvName.AllYdb, ErrorTypeName = "Ydb.Sdk.Ado.YdbException", ErrorMessage = "dq_opt_phy_finalizing.cpp",
			Details = "YDB 26.1.1.20 server optimizer assertion (dq_opt_phy_finalizing.cpp:540 'requirement false failed') on a LEFT JOIN of two LIMIT-ed UNION ALL subqueries; regression from the release's Shuffle Elimination.")]
		[Test]
