...
namespace Tests.Linq
{
	...
	public class SqlRowTests : TestBase
	{
		...
		[Test(Description = "https://github.com/linq2db/linq2db/issues/3631")]
		public void Issue3631Test3([DataSources(TestProvName.AllNativeAccess, TestProvName.AllAccessLibRed, TestProvName.AllSqlServer, TestProvName.AllSybase, ProviderName.SqlCe)] string context)
		{
			using var db = GetDataContext(context);
			using var tb = db.CreateLocalTable(Issue3631Table.Data);
