...
namespace Tests.Linq
{
	public class DefaultIfEmptyTests : TestBase
	{
		...
		public void WithoutDefault([DataSources(TestProvName.AllNativeAccess, TestProvName.AllClickHouse, TestProvName.AllInformix, TestProvName.AllYdb)] string context)
		{
		...
		[Test]
		[ThrowsForProvider(typeof(LinqToDBException), TestProvName.AllSybase, ErrorMessage = ErrorHelper.Sybase.Error_JoinToDerivedTableWithTakeInvalid)]
		public void WithDefault([DataSources(TestProvName.AllNativeAccess, TestProvName.AllClickHouse, TestProvName.AllInformix, TestProvName.AllYdb)] string context)
		{
			using var db = GetDataContext(context);
		...
		public void WithDefaultInSubquery([DataSources(TestProvName.AllNativeAccess, TestProvName.AllClickHouse)] string context)
		{
			using var db = GetDataContext(context);
