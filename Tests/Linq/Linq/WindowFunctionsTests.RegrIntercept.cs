...
namespace Tests.Linq
{
	partial class WindowFunctionsTests
	{
		...
		public void RegrInterceptBasic([SupportsAnalyticFunctionsContext] string context)
		{
			...
			var query =
				...
				{
					Id    = t.Id,
					Value = Sql.Window.RegrIntercept(t.DoubleValue, t.IntValue, w => w.PartitionBy(t.CategoryId).OrderBy(t.Id)),
				};

			var sql = query.ToSqlQuery().Sql;
			sql.ShouldContain("REGR_INTERCEPT");
		...
		[ThrowsForProvider(typeof(LinqToDBException),
			...
			ProviderName.Firebird3, ProviderName.Firebird4, TestProvName.AllFirebird5Plus, TestProvName.AllSapHana, TestProvName.AllInformix, ProviderName.Ydb,
			ErrorMessage = ErrorHelper.Error_WindowFunction_LinearRegression)]
		public void RegrInterceptViaWindow([SupportsAnalyticFunctionsContext] string context)
		{
			var data = WindowFunctionTestEntity.Seed();
			...
			var query =
				...
				{
					Id    = t.Id,
					Value = Sql.Window.RegrIntercept(t.DoubleValue, t.IntValue, w => w.UseWindow(wnd)),
				};
