...
namespace Tests.Linq
{
	public class CachingTests: TestBase
	{
		...
		[ActiveIssueNew(4266, ErrorMessage = "Assert.That(query.GetCacheMissCount(), Is.EqualTo(currentMiss + 1))",
		...
		[ActiveIssueNew(4266, ErrorMessage = "Expected and result lists are different",
