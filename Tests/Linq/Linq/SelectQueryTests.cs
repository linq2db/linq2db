...
namespace Tests.Linq
{
	...
	public class SelectQueryTests : TestBase
	{
		...
		public void Select_GroupBy_SelectAgain([DataSources(ProviderName.Firebird25, TestProvName.AllAccess, TestProvName.AllSqlServer2017, ProviderName.SqlCe)] string context)
		{
			using (var db = GetDataContext(context))
			{
				var query = db.Person
