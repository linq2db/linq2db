...
namespace Tests.Linq
{
	partial class WindowFunctionsTests
	{
		...
		public void SumOverloads([DataSources(TestProvName.AllOracleNative)] string context)
		{
		...
		[Test]
		[ThrowsForProvider(typeof(LinqToDBException), TestProvName.AllMySql57, ErrorMessage = ErrorHelper.Error_WindowFunction_NotSupported)]
		public void SumOverloadsViaWindow([DataSources(TestProvName.AllOracleNative)] string context)
		{
			var data = WindowFunctionTestEntity.Seed();
