...
namespace Tests.Linq
{
	...
	public class AssociationTests : TestBase
	{
		...
		[Test]
		public void MultipleUse([IncludeDataSources(TestProvName.AllSqlServer, TestProvName.AllPostgreSQL93Plus, TestProvName.AllOracle12Plus, TestProvName.AllMySql, TestProvName.AllSapHana)] string context)
		{
...
#pragma warning restore CS0472
		...
		[ActiveIssue(
			Configurations = [TestProvName.AllAccess, TestProvName.AllSybase, TestProvName.AllSQLite, ProviderName.SqlCe, TestProvName.AllSapHana, ProviderName.DB2],
			Details = "Missing sanitation of aliases (should remove or escape unsupported characters)")]
