...
namespace Tests.Linq
{
	...
	public class DistinctTests : TestBase
	{
		...
		[Test]
		public void Distinct5([DataSources] string context, [Values(0, 1)] int iteration, [Values(2, 3)] int id)
		{
			using var db = GetDataContext(context);
		...
		[Test]
		public void Distinct6([DataSources] string context, [Values(0, 1)] int iteration, [Values(2, 3)] int id)
		{
			using var db = GetDataContext(context);
