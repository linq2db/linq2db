...
namespace Tests.Linq
{
	partial class WindowFunctionsTests
	{
		...
		public void LeadBoolean([SupportsAnalyticFunctionsContext] string context)
		{
			...
			var result =
				...
				{
					Id      = t.Id,
					Boolean = Sql.Window.Lead(t.IntValue == 20, w => w.OrderBy(t.Id)),
					Value   = Sql.Window.Lead(t.IntValue,       w => w.OrderBy(t.Id)),
				})
				.OrderBy(t => t.Id)
				.ToList();

			// The folded flag must round-trip as a bool matching the same window's leading value.
