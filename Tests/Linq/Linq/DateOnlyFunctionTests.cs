...
namespace Tests.Linq
{
	...
	public class DateOnlyFunctionTests : TestBase
	{
		...
		private const string DateOnlySkipProviders = $"{TestProvName.AllNativeAccess},{ProviderName.SqlCe},{TestProvName.AllSqlServer2005},{ProviderName.PostgreSQL92},{ProviderName.PostgreSQL93}";
