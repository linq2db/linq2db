...
namespace Tests.UserTests
{
	...
	public class Issue5616Tests : TestBase
	{
		...
		[Test]
		public void Average_InUnionAll([IncludeDataSources(TestProvName.AllSQLite)] string context)
		{
		...
		[Test]
		public void CustomAggregate_InUnionAll([IncludeDataSources(TestProvName.AllSQLite)] string context)
		{
			using var db = GetDataContext(context);
