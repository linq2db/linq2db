...
namespace Tests.UserTests
{
	...
	public class Issue548Tests
	{
		...
		{ 
			...
			Assert.IsEmpty(ms.GetAttributes<PrimaryKeyAttribute>(typeof(TestEntity).GetProperty("Id")));
		...
		public void Test2()
		{
			...
			Assert.IsEmpty(ms.GetAttributes<ColumnAttribute>(typeof(TestEntity).GetProperty("Id")));
			Assert.IsEmpty(ms.GetAttributes<ColumnAttribute>(typeof(TestEntity).GetProperty("Value")));
		...
		private void Test2Internal1(MappingSchema ms, Semaphore semaphore1, Semaphore semaphore2)
		{
			try
			{
				...
				Assert.IsNotEmpty(ms.GetAttributes<ColumnAttribute>(typeof(TestEntity).GetProperty("Id")));
				Assert.IsNotEmpty(ms.GetAttributes<ColumnAttribute>(typeof(TestEntity).GetProperty("Value")));
