...
namespace Tests.xUpdate
{
	...
	public class InsertTests : TestBase
	{
		...
		public void Issue3927Test1([DataSources(TestProvName.AllSybase, TestProvName.AllSybase)] string context)
		{
			using var db = GetDataContext(context);
		...
		[Test(Description = "https://github.com/linq2db/linq2db/issues/3927")]
		public void Issue3927Test2([DataSources(TestProvName.AllSybase, TestProvName.AllSybase)] string context)
		{
			using var db = GetDataContext(context);
			using var tb = db.CreateLocalTable<Issue3927Table>();
