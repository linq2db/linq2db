...
namespace Tests.DataProvider
{
	...
	public class OracleTests : TestBase
	{
		...
		*/
		...
		void TestNumeric<T>(IDataContext conn, T expectedValue, DataType dataType, string skip = "")
		{
		...
		void TestSimple<T>(IDataContext conn, T expectedValue, DataType dataType)
			where T : struct
		{
...
#region XmlTable
		...
		public void UseAlternativeBulkCopyInsertIntoTest([IncludeDataSources(TestProvName.AllOracle)] string context)
		{
			...
			using var db = GetDataContext(context, o => o.UseOracle(o => o with { AlternativeBulkCopy = AlternativeBulkCopy.InsertInto }));
		...
		public void UseAlternativeBulkCopyInsertDualTest([IncludeDataSources(TestProvName.AllOracle)] string context)
		{
			...
			using var db = GetDataContext(context, o => o.UseOracle(o => o with { AlternativeBulkCopy = AlternativeBulkCopy.InsertDual }));
...
CREATE TABLE ""TABLE_A""(
	...
	CONSTRAINT ""PK_TABLE_A"" PRIMARY KEY(""COLUMN_A"", ""COLUMN_B"", ""COLUMN_C"")
		...
		[Test(Description = "https://github.com/linq2db/linq2db/issues/1879")]
		public void TestLegacyIdentityIgnoresKeepIdentity([IncludeDataSources(false, TestProvName.AllOracle11)] string context)
		{
			using var db    = GetDataConnection(context);
			using var table = db.CreateLocalTable<NativeIdentity>();
			...
			// the generated trigger assigns from the sequence unconditionally, so the supplied ids are discarded.
			// Oracle 12+ keeps them, because there the identity is generated by the column itself
