...
namespace Tests.DataProvider
{
	...
	public sealed  class PostgreSQLTypeTests : TypeTestsBase
	{
		...
		[ActiveIssue(ErrorTypeName = "LinqToDB.Common.LinqToDBConvertException",
		...
		[ActiveIssue(Configuration = TestProvName.AllPostgreSQL93Minus, ErrorTypeName = "Npgsql.PostgresException",
