...
namespace Tests
{
	public static class TestProvName
	{
		...
		public const string AllPostgreSQL12Plus  = $"{PostgreSQL12},{AllPostgreSQL13Plus}";
		...
		public const string AllPostgreSQL10Minus = $"{AllPostgreSQL9},{PostgreSQL10}";
		...
		#region Firebird
		public const string AllFirebird6Plus = ProviderName.Firebird6;
		public const string AllFirebird5Plus = $"{ProviderName.Firebird5},{AllFirebird6Plus}";
		...
		public const string AllFirebirdLess6 = $"{AllFirebirdLess5},{ProviderName.Firebird5}";
		public const string AllFirebird      = $"{AllFirebirdLess6},{ProviderName.Firebird6}";
		#endregion
