...
namespace Tests
{
	public static class TestProvName
	{
		...
		public const string AllPostgreSQL10Plus  = $"{PostgreSQL10},{PostgreSQL11},{PostgreSQL12},{PostgreSQL13},{PostgreSQL14},{ProviderName.PostgreSQL15}";
		...
		public const string AllOracleDevartOCI     = $"{Oracle11DevartOCI},{Oracle12DevartOCI},{Oracle18DevartOCI},{Oracle21DevartOCI},{Oracle23DevartOCI}";
		public const string AllOracleDevartDirect  = $"{Oracle11DevartDirect},{Oracle12DevartDirect},{Oracle18DevartDirect},{Oracle21DevartDirect},{Oracle23DevartDirect}";
		public const string AllOracleDevart        = $"{AllOracleDevartOCI},{AllOracleDevartDirect}";

		public const string AllOracleManaged       = $"{ProviderName.Oracle11Managed},{Oracle12Managed},{Oracle18Managed},{Oracle21Managed},{Oracle23Managed}";
		public const string AllOracleNative        = $"{ProviderName.Oracle11Native},{Oracle12Native},{Oracle18Native},{Oracle21Native},{Oracle23Native}";
		...
		public const string AllOracle12Plus        = $"{AllOracle12},{AllOracle18},{AllOracle21},{AllOracle23}";
