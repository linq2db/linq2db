...
namespace Tests.DataProvider
{
	public class DataProviderTestBase : TestBase
	{
			...
			bool     skipUndefined     = false)
		{
			...
			tableName = conn.DataProvider.CreateSqlBuilder(conn.DataProvider.MappingSchema, conn.Options.LinqOptions).ConvertInline(tableName, ConvertType.NameToQueryTable);
