...
{
	public partial class TestdataconnectorDB : LinqToDB.Data.DataConnection
	{
		#region Tables
		...
		public TestdataconnectorDB()
		{
			InitDataContext();
			InitMappingSchema();
		}

		public TestdataconnectorDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public TestdataconnectorDB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public TestdataconnectorDB(DataOptions<TestdataconnectorDB> options)
	...
	public partial class Doctor
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MySqlConnectorDataContext.Person.PersonID), CanBeNull=false)]
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MySqlConnectorDataContext.Doctor.PersonID), CanBeNull=true)]
		public Doctor? Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MySqlConnectorDataContext.Patient.PersonID), CanBeNull=true)]
	...
	public static partial class TestdataconnectorDBStoredProcedures
	{
		#region AddIssue792Record

		public static int AddIssue792Record(this TestdataconnectorDB dataConnection)
		{
		...
		public static int TestOutputParametersWithoutTableProcedure(this TestdataconnectorDB dataConnection, string? aInParam, out bool? aOutParam)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<Person> TestProcedure(this TestdataconnectorDB dataConnection, int? param3, ref int? param2, out int? param1)
		{
			var parameters = new []
			{
