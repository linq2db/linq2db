...
namespace AccessODBCDataContext
{
	...
	{
		[Column(                            DbType="COUNTER",        DataType=DataType.Int32),                            Identity   ] public int       ID                       { get; set; } // COUNTER
		...
		[Column("intDataType",              DbType="INTEGER",        DataType=DataType.Int32),                               Nullable] public int?      IntDataType              { get; set; } // INTEGER
		...
		[Column("textDataType",             DbType="LONGCHAR",       DataType=DataType.NText),                               Nullable] public string?   TextDataType             { get; set; } // LONGCHAR
		...
		[Column("ntextDataType",            DbType="LONGCHAR",       DataType=DataType.NText),                               Nullable] public string?   NtextDataType            { get; set; } // LONGCHAR
		[Column("binaryDataType",           DbType="BINARY(10)",     DataType=DataType.Binary,    Length=10),                Nullable] public byte[]?   BinaryDataType           { get; set; } // BINARY(10)
	...
	{
		[Column(             DbType="COUNTER",     DataType=DataType.Int32),               Identity] public int       DataTypeID { get; set; } // COUNTER
		[Column("Binary_",   DbType="LONGBINARY",  DataType=DataType.Image),               Nullable] public byte[]?   Binary     { get; set; } // LONGBINARY
		[Column("Boolean_",  DbType="INTEGER",     DataType=DataType.Int32),               Nullable] public int?      Boolean    { get; set; } // INTEGER
		...
		[Column("Int32_",    DbType="INTEGER",     DataType=DataType.Int32),               Nullable] public int?      Int32      { get; set; } // INTEGER
		[Column("Int64_",    DbType="INTEGER",     DataType=DataType.Int32),               Nullable] public int?      Int64      { get; set; } // INTEGER
		...
		[Column("UInt32_",   DbType="INTEGER",     DataType=DataType.Int32),               Nullable] public int?      UInt32     { get; set; } // INTEGER
		[Column("UInt64_",   DbType="INTEGER",     DataType=DataType.Int32),               Nullable] public int?      UInt64     { get; set; } // INTEGER
		[Column("Xml_",      DbType="LONGCHAR",    DataType=DataType.NText),               Nullable] public string?   Xml        { get; set; } // LONGCHAR
	}

	[Table("Doctor")]
	public partial class Doctor
	{
		[Column(DbType="INTEGER",     DataType=DataType.Int32),              Nullable] public int?    PersonID { get; set; } // INTEGER
		[Column(DbType="VARCHAR(50)", DataType=DataType.VarChar, Length=50), Nullable] public string? Taxonomy { get; set; } // VARCHAR(50)
	}
	...
	{
		[Column(DbType="INTEGER",     DataType=DataType.Int32),              Nullable] public int?    InheritanceChildId  { get; set; } // INTEGER
		[Column(DbType="INTEGER",     DataType=DataType.Int32),              Nullable] public int?    InheritanceParentId { get; set; } // INTEGER
	...
	public partial class LinqDataType
	{
		...
		[Column(DbType="INTEGER",        DataType=DataType.Int32),                              Nullable] public int?      BigIntValue    { get; set; } // INTEGER
	...
	{
		[Column(DbType="COUNTER",      DataType=DataType.Int32),               Identity] public int     PersonID   { get; set; } // COUNTER
	...
	{
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? ID1   { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? ID2   { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? Int1  { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? Int2  { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? IntN1 { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? IntN2 { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? FK    { get; set; } // INTEGER
		[Column(DbType="INTEGER", DataType=DataType.Int32), Nullable] public int? FKN   { get; set; } // INTEGER
	}

	[Table("Scalar_DataReader", IsView=true)]
	public partial class ScalarDataReader
	{
		[Column("intField",    DbType="INTEGER", DataType=DataType.Int32),   Nullable] public int?    IntField    { get; set; } // INTEGER
		[Column("stringField", DbType="VARCHAR", DataType=DataType.VarChar), Nullable] public string? StringField { get; set; } // VARCHAR
	}
