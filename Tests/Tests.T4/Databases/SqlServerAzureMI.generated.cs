...
namespace TestAzureSQLMi
{
	public partial class TestDataDB : LinqToDB.Data.DataConnection
	{
		...
		public ITable<MssqlTemporalHistoryFor1831677573> MssqlTemporalHistoryFor1831677573 { get { return this.GetTable<MssqlTemporalHistoryFor1831677573>(); } }
		public ITable<MssqlTemporalHistoryFor1975678086> MssqlTemporalHistoryFor1975678086 { get { return this.GetTable<MssqlTemporalHistoryFor1975678086>(); } }
		public ITable<MssqlTemporalHistoryFor20195122>   MssqlTemporalHistoryFor20195122   { get { return this.GetTable<MssqlTemporalHistoryFor20195122>(); } }
		public ITable<MssqlTemporalHistoryFor2023678257> MssqlTemporalHistoryFor2023678257 { get { return this.GetTable<MssqlTemporalHistoryFor2023678257>(); } }
	...
	public partial class Doctor
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(TestAzureSQLMi.Person.PersonID), CanBeNull=false)]
	...
	public partial class IndexTable
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PKField2) + ", " + nameof(PKField1), OtherKey=nameof(TestAzureSQLMi.IndexTable2.PKField2) + ", " + nameof(TestAzureSQLMi.IndexTable2.PKField1), CanBeNull=true)]
	...
	public partial class IndexTable2
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PKField2) + ", " + nameof(PKField1), OtherKey=nameof(TestAzureSQLMi.IndexTable.PKField2) + ", " + nameof(TestAzureSQLMi.IndexTable.PKField1), CanBeNull=false)]
	...
	public partial class Member
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(MemberId), OtherKey=nameof(TestAzureSQLMi.Provider.ProviderId), CanBeNull=true)]
		public Provider? Provider { get; set; }

		#endregion
	}

	[Table(Schema="dbo", Name="MSSQL_TemporalHistoryFor_1831677573")]
	public partial class MssqlTemporalHistoryFor1831677573
	{
		[Column, NotNull    ] public int      Id        { get; set; } // int
		[Column,    Nullable] public string?  Name      { get; set; } // nvarchar(10)
		[Column, NotNull    ] public DateTime ValidFrom { get; set; } // datetime2(7)
		[Column, NotNull    ] public DateTime ValidTo   { get; set; } // datetime2(7)
	}

	[Table(Schema="dbo", Name="MSSQL_TemporalHistoryFor_1975678086")]
	public partial class MssqlTemporalHistoryFor1975678086
	{
		[Column, NotNull    ] public int      Id        { get; set; } // int
		[Column,    Nullable] public string?  Name      { get; set; } // nvarchar(10)
		[Column, NotNull    ] public DateTime ValidFrom { get; set; } // datetime2(7)
	...
	[Table(Schema="dbo", Name="MSSQL_TemporalHistoryFor_20195122")]
	public partial class MssqlTemporalHistoryFor20195122
	{
		[Column, NotNull    ] public int      Id        { get; set; } // int
		[Column,    Nullable] public string?  Name      { get; set; } // nvarchar(10)
		[Column, NotNull    ] public DateTime ValidFrom { get; set; } // datetime2(7)
	...
	[Table(Schema="dbo", Name="MSSQL_TemporalHistoryFor_2023678257")]
	public partial class MssqlTemporalHistoryFor2023678257
	{
		[Column, NotNull    ] public int      Id        { get; set; } // int
		[Column,    Nullable] public string?  Name      { get; set; } // nvarchar(10)
		[Column, NotNull    ] public DateTime ValidFrom { get; set; } // datetime2(7)
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(TestAzureSQLMi.Doctor.PersonID), CanBeNull=true)]
		public Doctor? Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (dbo.Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(TestAzureSQLMi.Patient.PersonID), CanBeNull=true)]
	...
	public partial class Provider
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(ProviderId), OtherKey=nameof(TestAzureSQLMi.Member.MemberId), CanBeNull=false)]
	...
	public partial class TestSchema_TestSchemaA
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaAID), OtherKey=nameof(TestAzureSQLMi.TestSchema_TestSchemaB.TargetTestSchemaAId), CanBeNull=true)]
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaAID), OtherKey=nameof(TestAzureSQLMi.TestSchema_TestSchemaB.OriginTestSchemaAID), CanBeNull=true)]
	...
	public partial class TestSchema_TestSchemaB
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TargetTestSchemaAID), OtherKey=nameof(TestAzureSQLMi.TestSchema_TestSchemaA.TestSchemaAID), CanBeNull=false)]
		...
		/// </summary>
		[Association(ThisKey=nameof(OriginTestSchemaAID), OtherKey=nameof(TestAzureSQLMi.TestSchema_TestSchemaA.TestSchemaAID), CanBeNull=false)]
	...
	public partial class TestSchemaX
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(TestAzureSQLMi.TestSchemaY.TestSchemaXID), CanBeNull=true)]
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(TestAzureSQLMi.TestSchemaY.ParentTestSchemaXID), CanBeNull=true)]
	...
	public partial class TestSchemaY
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(TestAzureSQLMi.TestSchemaX.TestSchemaXID), CanBeNull=false)]
		public TestSchemaX FkTestSchemaYOtherID { get; set; } = null!;

		/// <summary>
		/// FK_TestSchemaY_ParentTestSchemaX (dbo.TestSchemaX)
		/// </summary>
		[Association(ThisKey=nameof(ParentTestSchemaXID), OtherKey=nameof(TestAzureSQLMi.TestSchemaX.TestSchemaXID), CanBeNull=false)]
