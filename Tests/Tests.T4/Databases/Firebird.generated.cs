...
namespace FirebirdDataContext
{
	public partial class TESTDB25DB : LinqToDB.Data.DataConnection
	{
		...
		public TESTDB25DB(DataContextOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public TESTDB25DB(DataContextOptions<TESTDB25DB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public partial class Person
	{
		...
		/// <summary>
		/// INTEG_9435_BackReference (SYSDBA.Patient)
		/// </summary>
		[Association(ThisKey="PersonID", OtherKey="PersonID", CanBeNull=true)]
