...
namespace EquatableDataContext
{
	public partial class EquatableDB : LinqToDB.Data.DataConnection
	{
		#region Tables
		...
		public EquatableDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public EquatableDB(DataOptions<EquatableDB> options)
	...
	public partial class AllType : IEquatable<AllType>
	{
	...
	public partial class FKTestPosition : IEquatable<FKTestPosition>
	{
		...
		public override bool Equals(object? obj)
		{
			if (!(obj is FKTestPosition other))
				return false;
	...
	public partial class Person : IEquatable<Person>
	{
		...
		[Column,     NotNull    ] public string  Gender     { get; set; } = null!; // char(1)
	...
	public partial class PrimaryKeyTable : IEquatable<PrimaryKeyTable>
	{
		...
		public override bool Equals(object? obj)
		{
			if (!(obj is PrimaryKeyTable other))
				return false;
	...
	public partial class TestIdentity : IEquatable<TestIdentity>
	{
