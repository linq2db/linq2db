...
namespace Cli.All.MariaDB
{
	...
	{
		[Column("InheritanceParentId", DataType = DataType.Int32  , DbType = "int(11)"    , Precision = 10, Scale = 0, IsPrimaryKey = true)] public int     InheritanceParentId { get; set; } // int(11)
		[Column("TypeDiscriminator"  , DataType = DataType.Int32  , DbType = "int(11)"    , Precision = 10, Scale = 0                     )] public int?    TypeDiscriminator   { get; set; } // int(11)
