...
namespace Cli.All.MariaDB
{
	...
	{
		[Column("PersonID"  , DataType  = DataType.Int32  , DbType   = "int(11)"       , Precision = 10           , Scale  = 0 , IsPrimaryKey = true, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int     PersonId   { get; set; } // int(11)
