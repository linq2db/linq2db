...
namespace Cli.All.MariaDB
{
	...
	{
		[Column("id"        , DataType = DataType.UInt32, DbType = "int(10) unsigned", Precision = 10   , Scale = 0, IsPrimaryKey = true, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public uint    Id         { get; set; } // int(10) unsigned
