...
namespace Cli.All.MariaDB
{
	...
	{
		[Column("InheritanceChildId" , DataType = DataType.Int32  , DbType = "int(11)"    , Precision = 10, Scale = 0, IsPrimaryKey = true)] public int     InheritanceChildId  { get; set; } // int(11)
		[Column("InheritanceParentId", DataType = DataType.Int32  , DbType = "int(11)"    , Precision = 10, Scale = 0                     )] public int     InheritanceParentId { get; set; } // int(11)
