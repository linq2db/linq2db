...
namespace Cli.All.MariaDB
{
	...
	public class AllType : IEquatable<AllType>
	{
		...
		[Column("bigintDataType"     , DataType = DataType.Int64    , DbType = "bigint(20)"                , Precision = 19   , Scale = 0                                                                                  )] public long?     BigintDataType      { get; set; } // bigint(20)
		[Column("smallintDataType"   , DataType = DataType.Int16    , DbType = "smallint(6)"               , Precision = 5    , Scale = 0                                                                                  )] public short?    SmallintDataType    { get; set; } // smallint(6)
		[Column("tinyintDataType"    , DataType = DataType.SByte    , DbType = "tinyint(4)"                , Precision = 3    , Scale = 0                                                                                  )] public sbyte?    TinyintDataType     { get; set; } // tinyint(4)
		[Column("mediumintDataType"  , DataType = DataType.Int32    , DbType = "mediumint(9)"              , Precision = 7    , Scale = 0                                                                                  )] public int?      MediumintDataType   { get; set; } // mediumint(9)
		[Column("intDataType"        , DataType = DataType.Int32    , DbType = "int(11)"                   , Precision = 10   , Scale = 0                                                                                  )] public int?      IntDataType         { get; set; } // int(11)
		...
		[Column("yearDataType"       , DataType = DataType.Int32    , DbType = "year(4)"                                                                                                                                   )] public int?      YearDataType        { get; set; } // year(4)
		[Column("year2DataType"      , DataType = DataType.Int32    , DbType = "year(4)"                                                                                                                                   )] public int?      Year2DataType       { get; set; } // year(4)
		[Column("year4DataType"      , DataType = DataType.Int32    , DbType = "year(4)"                                                                                                                                   )] public int?      Year4DataType       { get; set; } // year(4)
		...
		[Column("intUnsignedDataType", DataType = DataType.UInt32   , DbType = "int(10) unsigned"          , Precision = 10   , Scale = 0                                                                                  )] public uint?     IntUnsignedDataType { get; set; } // int(10) unsigned
