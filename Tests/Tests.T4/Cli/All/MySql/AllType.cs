...
namespace Cli.All.MySql
{
	...
	public class AllType : IEquatable<AllType>
	{
		...
		[Column("year2DataType"      , DataType = DataType.Int32    , DbType = "year"                                                                                                                                      )] public int?      Year2DataType       { get; set; } // year
		[Column("year4DataType"      , DataType = DataType.Int32    , DbType = "year"                                                                                                                                      )] public int?      Year4DataType       { get; set; } // year
