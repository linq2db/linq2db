...
namespace Cli.All.MySql
{
	...
	{
		[Column("InheritanceChildId" , DataType = DataType.Int32  , DbType = "int"        , Precision = 10, Scale = 0, IsPrimaryKey = true)] public int     InheritanceChildId  { get; set; } // int
		[Column("InheritanceParentId", DataType = DataType.Int32  , DbType = "int"        , Precision = 10, Scale = 0                     )] public int     InheritanceParentId { get; set; } // int
		[Column("TypeDiscriminator"  , DataType = DataType.Int32  , DbType = "int"        , Precision = 10, Scale = 0                     )] public int?    TypeDiscriminator   { get; set; } // int
