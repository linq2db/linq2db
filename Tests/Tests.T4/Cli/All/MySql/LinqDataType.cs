...
namespace Cli.All.MySql
{
	...
	public class LinqDataType
	{
		...
		[Column("SmallIntValue" , DataType = DataType.Int16    , DbType = "smallint"       , Precision = 5   , Scale = 0)] public short?    SmallIntValue  { get; set; } // smallint
		[Column("IntValue"      , DataType = DataType.Int32    , DbType = "int"            , Precision = 10  , Scale = 0)] public int?      IntValue       { get; set; } // int
		[Column("BigIntValue"   , DataType = DataType.Int64    , DbType = "bigint"         , Precision = 19  , Scale = 0)] public long?     BigIntValue    { get; set; } // bigint
