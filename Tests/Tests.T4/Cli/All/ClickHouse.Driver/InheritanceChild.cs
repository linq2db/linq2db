...
namespace Cli.All.ClickHouse.Driver
{
	...
	{
		[Column("InheritanceChildId" , DataType = DataType.Int32   , DbType = "Int32" , IsPrimaryKey = true, SkipOnUpdate = true)] public int     InheritanceChildId  { get; set; } // Int32
		[Column("InheritanceParentId", DataType = DataType.Int32   , DbType = "Int32"                                           )] public int     InheritanceParentId { get; set; } // Int32
