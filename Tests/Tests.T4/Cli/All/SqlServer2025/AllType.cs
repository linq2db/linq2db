...
namespace Cli.All.SqlServer2025
{
	...
	public class AllType : IEquatable<AllType>
	{
		...
		[Column("jsonDataType"            , DataType = LinqToDB.DataType.Json          , DbType = "json"                                                                                                       )] public SqlJson?          JsonDataType             { get; set; } // json
		[Column("vectorDataType"          , DataType = LinqToDB.DataType.Vector32      , DbType = "vector(5)"        , Length       = 5                                                                        )] public SqlVector<float>? VectorDataType           { get; set; } // vector(5)
