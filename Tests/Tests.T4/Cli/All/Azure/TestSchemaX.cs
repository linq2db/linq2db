...
namespace Cli.All.SqlServer.Azure
{
	...
	public class TestSchemaX : IEquatable<TestSchemaX>
	{
		...
		/// </summary>
		[Association(ThisKey = nameof(TestSchemaXid), OtherKey = nameof(Azure.TestSchemaY.TestSchemaXid))]
		public IEnumerable<TestSchemaY> TestSchemaY { get; set; } = null!;

		/// <summary>
		/// FK_TestSchemaY_ParentTestSchemaX backreference
		/// </summary>
		[Association(ThisKey = nameof(TestSchemaXid), OtherKey = nameof(Azure.TestSchemaY.ParentTestSchemaXid))]
