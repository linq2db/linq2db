...
namespace Cli.All.Sybase
{
	...
	public class AllType
	{
		...
		[Column("ncharDataType"        , DataType = DataType.NChar        , DbType = "nchar(60)"     , Length = 60                                                               )] public string?   NcharDataType         { get; set; } // nchar(60)
		[Column("nvarcharDataType"     , DataType = DataType.NVarChar     , DbType = "nvarchar(60)"  , Length = 60                                                               )] public string?   NvarcharDataType      { get; set; } // nvarchar(60)
