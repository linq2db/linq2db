...
namespace Cli.All.SQLite
{
	...
	{
		[Column("ID"                      , DataType = DataType.Int64    , DbType = "integer"         , Length    = 8         , Precision = 19, Scale = 0, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public long      Id                       { get; set; } // integer
		...
		[Column("Number"                  , DbType   = "NUMERIC"         , Length = 2147483647        , Precision = 0         , Scale     = 0                                                                         )] public object?   Number                   { get; set; } // NUMERIC
	}
}
