...
namespace Cli.All.Ydb
{
	...
	public static partial class ExtensionMethods
	{
		...
		public static Task<Child?> FindAsync(this ITable<Child> table, int childId, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.ChildId == childId, cancellationToken);
		}

		public static IQueryable<Child> FindQuery(this ITable<Child> table, int childId)
		{
			return table.Where(e => e.ChildId == childId);
		}

		public static Child? Find(this ITable<Child> table, Child @record)
		{
			return table.FirstOrDefault(e => e.ChildId == @record.ChildId);
		}

		public static Task<Child?> FindAsync(this ITable<Child> table, Child @record, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.ChildId == @record.ChildId, cancellationToken);
		}

		public static IQueryable<Child> FindQuery(this ITable<Child> table, Child @record)
		{
			return table.Where(e => e.ChildId == @record.ChildId);
		}

		public static Child? FindChild(this TestDataDB db, int childId)
		{
			return db.GetTable<Child>().FirstOrDefault(e => e.ChildId == childId);
		}

		public static Task<Child?> FindChildAsync(this TestDataDB db, int childId, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Child>().FirstOrDefaultAsync(e => e.ChildId == childId, cancellationToken);
		}

		public static IQueryable<Child> FindChildQuery(this TestDataDB db, int childId)
		{
			return db.GetTable<Child>().Where(e => e.ChildId == childId);
		}

		public static Child? Find(this TestDataDB db, Child @record)
		{
			return db.GetTable<Child>().FirstOrDefault(e => e.ChildId == @record.ChildId);
		}

		public static Task<Child?> FindAsync(this TestDataDB db, Child @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Child>().FirstOrDefaultAsync(e => e.ChildId == @record.ChildId, cancellationToken);
		}

		public static IQueryable<Child> FindQuery(this TestDataDB db, Child @record)
		{
			return db.GetTable<Child>().Where(e => e.ChildId == @record.ChildId);
		}
		...
		public static Task<GrandChild?> FindAsync(this ITable<GrandChild> table, int? grandChildId, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.GrandChildId == grandChildId, cancellationToken);
		}

		public static IQueryable<GrandChild> FindQuery(this ITable<GrandChild> table, int? grandChildId)
		{
			return table.Where(e => e.GrandChildId == grandChildId);
		}

		public static GrandChild? Find(this ITable<GrandChild> table, GrandChild @record)
		{
			return table.FirstOrDefault(e => e.GrandChildId == @record.GrandChildId);
		}
		...
		{
			return table.FirstOrDefaultAsync(e => e.GrandChildId == @record.GrandChildId, cancellationToken);
		}

		public static IQueryable<GrandChild> FindQuery(this ITable<GrandChild> table, GrandChild @record)
		{
			return table.Where(e => e.GrandChildId == @record.GrandChildId);
		}

		public static GrandChild? FindGrandChild(this TestDataDB db, int? grandChildId)
		{
			return db.GetTable<GrandChild>().FirstOrDefault(e => e.GrandChildId == grandChildId);
		}

		public static Task<GrandChild?> FindGrandChildAsync(this TestDataDB db, int? grandChildId, CancellationToken cancellationToken = default)
		{
			return db.GetTable<GrandChild>().FirstOrDefaultAsync(e => e.GrandChildId == grandChildId, cancellationToken);
		}

		public static IQueryable<GrandChild> FindGrandChildQuery(this TestDataDB db, int? grandChildId)
		{
			return db.GetTable<GrandChild>().Where(e => e.GrandChildId == grandChildId);
		}

		public static GrandChild? Find(this TestDataDB db, GrandChild @record)
		{
			return db.GetTable<GrandChild>().FirstOrDefault(e => e.GrandChildId == @record.GrandChildId);
		}

		public static Task<GrandChild?> FindAsync(this TestDataDB db, GrandChild @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<GrandChild>().FirstOrDefaultAsync(e => e.GrandChildId == @record.GrandChildId, cancellationToken);
		}

		public static IQueryable<GrandChild> FindQuery(this TestDataDB db, GrandChild @record)
		{
			return db.GetTable<GrandChild>().Where(e => e.GrandChildId == @record.GrandChildId);
		}
		...
		public static Task<Parent?> FindAsync(this ITable<Parent> table, int parentId, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.ParentId == parentId, cancellationToken);
		}

		public static IQueryable<Parent> FindQuery(this ITable<Parent> table, int parentId)
		{
			return table.Where(e => e.ParentId == parentId);
		}

		public static Parent? Find(this ITable<Parent> table, Parent @record)
		{
			return table.FirstOrDefault(e => e.ParentId == @record.ParentId);
		}

		public static Task<Parent?> FindAsync(this ITable<Parent> table, Parent @record, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.ParentId == @record.ParentId, cancellationToken);
		}

		public static IQueryable<Parent> FindQuery(this ITable<Parent> table, Parent @record)
		{
			return table.Where(e => e.ParentId == @record.ParentId);
		}

		public static Parent? FindParent(this TestDataDB db, int parentId)
		{
			return db.GetTable<Parent>().FirstOrDefault(e => e.ParentId == parentId);
		}

		public static Task<Parent?> FindParentAsync(this TestDataDB db, int parentId, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Parent>().FirstOrDefaultAsync(e => e.ParentId == parentId, cancellationToken);
		}

		public static IQueryable<Parent> FindParentQuery(this TestDataDB db, int parentId)
		{
			return db.GetTable<Parent>().Where(e => e.ParentId == parentId);
		}

		public static Parent? Find(this TestDataDB db, Parent @record)
		{
			return db.GetTable<Parent>().FirstOrDefault(e => e.ParentId == @record.ParentId);
		}

		public static Task<Parent?> FindAsync(this TestDataDB db, Parent @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Parent>().FirstOrDefaultAsync(e => e.ParentId == @record.ParentId, cancellationToken);
		}

		public static IQueryable<Parent> FindQuery(this TestDataDB db, Parent @record)
		{
			return db.GetTable<Parent>().Where(e => e.ParentId == @record.ParentId);
		}
