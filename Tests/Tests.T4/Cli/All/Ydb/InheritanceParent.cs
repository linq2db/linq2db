...
namespace Cli.All.Ydb
{
	...
	{
		[Column("InheritanceParentId", DataType = DataType.Int32   , DbType = "Int32", IsPrimaryKey = true)] public int     InheritanceParentId { get; set; } // Int32
		[Column("TypeDiscriminator"  , DataType = DataType.Int32   , DbType = "Int32"                     )] public int?    TypeDiscriminator   { get; set; } // Int32
		[Column("Name"               , DataType = DataType.NVarChar, DbType = "Text"                      )] public string? Name                { get; set; } // Text
