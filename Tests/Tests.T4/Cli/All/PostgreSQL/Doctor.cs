...
namespace Cli.All.PostgreSQL
{
	...
	public class Doctor : IEquatable<Doctor>
	{
		...
		[Column("Taxonomy", CanBeNull = false         , DataType = DataType.NVarChar, DbType    = "character varying(50)", Length = 50                     )] public string Taxonomy { get; set; } = null!; // character varying(50)
