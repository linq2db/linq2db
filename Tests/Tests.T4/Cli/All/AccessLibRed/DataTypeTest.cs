...
namespace Cli.All.Access.LibRed
{
	...
	{
		[Column("DataTypeID", DataType = DataType.Int32   , DbType = "Long"       , IsPrimaryKey = true, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int       DataTypeId { get; set; } // Long
