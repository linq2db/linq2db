...
namespace Cli.All.Access.LibRed
{
	...
	{
		[Column("PersonID"  , DataType  = DataType.Int32  , DbType   = "Long"          , IsPrimaryKey = true         , IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int     PersonId   { get; set; } // Long
