...
namespace Cli.All.SqlServerNorthwind
{
	...
	public static partial class ExtensionMethods
	{
		...
		{
			return table.FirstOrDefault(e => (bool)(e.CategoryId == categoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CategoryId == categoryId), cancellationToken);
		}

		public static IQueryable<Category> FindQuery(this ITable<Category> table, SqlInt32 categoryId)
		{
			return table.Where(e => (bool)(e.CategoryId == categoryId));
		}

		public static Category? Find(this ITable<Category> table, Category @record)
		{
			return table.FirstOrDefault(e => (bool)(e.CategoryId == @record.CategoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CategoryId == @record.CategoryId), cancellationToken);
		}

		public static IQueryable<Category> FindQuery(this ITable<Category> table, Category @record)
		{
			return table.Where(e => (bool)(e.CategoryId == @record.CategoryId));
		}

		public static Category? FindCategory(this TestDataDB db, SqlInt32 categoryId)
		{
			return db.GetTable<Category>().FirstOrDefault(e => (bool)(e.CategoryId == categoryId));
		}
		...
		{
			return db.GetTable<Category>().FirstOrDefaultAsync(e => (bool)(e.CategoryId == categoryId), cancellationToken);
		}

		public static IQueryable<Category> FindCategoryQuery(this TestDataDB db, SqlInt32 categoryId)
		{
			return db.GetTable<Category>().Where(e => (bool)(e.CategoryId == categoryId));
		}

		public static Category? Find(this TestDataDB db, Category @record)
		{
			return db.GetTable<Category>().FirstOrDefault(e => (bool)(e.CategoryId == @record.CategoryId));
		}

		public static Task<Category?> FindAsync(this TestDataDB db, Category @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Category>().FirstOrDefaultAsync(e => (bool)(e.CategoryId == @record.CategoryId), cancellationToken);
		}

		public static IQueryable<Category> FindQuery(this TestDataDB db, Category @record)
		{
			return db.GetTable<Category>().Where(e => (bool)(e.CategoryId == @record.CategoryId));
		}
		...
		{
			return table.FirstOrDefault(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId), cancellationToken);
		}
		...
		{
			return table.Where(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId));
		}

		public static CustomerCustomerDemo? Find(this ITable<CustomerCustomerDemo> table, CustomerCustomerDemo @record)
		{
			return table.FirstOrDefault(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId), cancellationToken);
		}
		...
		{
			return table.Where(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}
		...
		{
			return db.GetTable<CustomerCustomerDemo>().FirstOrDefault(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId));
		}
		...
		{
			return db.GetTable<CustomerCustomerDemo>().FirstOrDefaultAsync(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId), cancellationToken);
		}
		...
		{
			return db.GetTable<CustomerCustomerDemo>().Where(e => (bool)(e.CustomerId == customerId) && (bool)(e.CustomerTypeId == customerTypeId));
		}

		public static CustomerCustomerDemo? Find(this TestDataDB db, CustomerCustomerDemo @record)
		{
			return db.GetTable<CustomerCustomerDemo>().FirstOrDefault(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}
		...
		{
			return db.GetTable<CustomerCustomerDemo>().FirstOrDefaultAsync(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId), cancellationToken);
		}

		public static IQueryable<CustomerCustomerDemo> FindQuery(this TestDataDB db, CustomerCustomerDemo @record)
		{
			return db.GetTable<CustomerCustomerDemo>().Where(e => (bool)(e.CustomerId == @record.CustomerId) && (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}

		public static CustomerDemographic? Find(this ITable<CustomerDemographic> table, SqlString customerTypeId)
		{
			return table.FirstOrDefault(e => (bool)(e.CustomerTypeId == customerTypeId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CustomerTypeId == @record.CustomerTypeId), cancellationToken);
		}

		public static IQueryable<CustomerDemographic> FindQuery(this ITable<CustomerDemographic> table, CustomerDemographic @record)
		{
			return table.Where(e => (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}

		public static CustomerDemographic? FindCustomerDemographic(this TestDataDB db, SqlString customerTypeId)
		{
			return db.GetTable<CustomerDemographic>().FirstOrDefault(e => (bool)(e.CustomerTypeId == customerTypeId));
		}
		...
		{
			return db.GetTable<CustomerDemographic>().FirstOrDefaultAsync(e => (bool)(e.CustomerTypeId == customerTypeId), cancellationToken);
		}

		public static IQueryable<CustomerDemographic> FindCustomerDemographicQuery(this TestDataDB db, SqlString customerTypeId)
		{
			return db.GetTable<CustomerDemographic>().Where(e => (bool)(e.CustomerTypeId == customerTypeId));
		}

		public static CustomerDemographic? Find(this TestDataDB db, CustomerDemographic @record)
		{
			return db.GetTable<CustomerDemographic>().FirstOrDefault(e => (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}
		...
		{
			return db.GetTable<CustomerDemographic>().FirstOrDefaultAsync(e => (bool)(e.CustomerTypeId == @record.CustomerTypeId), cancellationToken);
		}

		public static IQueryable<CustomerDemographic> FindQuery(this TestDataDB db, CustomerDemographic @record)
		{
			return db.GetTable<CustomerDemographic>().Where(e => (bool)(e.CustomerTypeId == @record.CustomerTypeId));
		}

		public static Customer? Find(this ITable<Customer> table, SqlString customerId)
		{
			return table.FirstOrDefault(e => (bool)(e.CustomerId == customerId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CustomerId == customerId), cancellationToken);
		}

		public static IQueryable<Customer> FindQuery(this ITable<Customer> table, SqlString customerId)
		{
			return table.Where(e => (bool)(e.CustomerId == customerId));
		}

		public static Customer? Find(this ITable<Customer> table, Customer @record)
		{
			return table.FirstOrDefault(e => (bool)(e.CustomerId == @record.CustomerId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.CustomerId == @record.CustomerId), cancellationToken);
		}

		public static IQueryable<Customer> FindQuery(this ITable<Customer> table, Customer @record)
		{
			return table.Where(e => (bool)(e.CustomerId == @record.CustomerId));
		}

		public static Customer? FindCustomer(this TestDataDB db, SqlString customerId)
		{
			return db.GetTable<Customer>().FirstOrDefault(e => (bool)(e.CustomerId == customerId));
		}
		...
		{
			return db.GetTable<Customer>().FirstOrDefaultAsync(e => (bool)(e.CustomerId == customerId), cancellationToken);
		}

		public static IQueryable<Customer> FindCustomerQuery(this TestDataDB db, SqlString customerId)
		{
			return db.GetTable<Customer>().Where(e => (bool)(e.CustomerId == customerId));
		}

		public static Customer? Find(this TestDataDB db, Customer @record)
		{
			return db.GetTable<Customer>().FirstOrDefault(e => (bool)(e.CustomerId == @record.CustomerId));
		}

		public static Task<Customer?> FindAsync(this TestDataDB db, Customer @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Customer>().FirstOrDefaultAsync(e => (bool)(e.CustomerId == @record.CustomerId), cancellationToken);
		}

		public static IQueryable<Customer> FindQuery(this TestDataDB db, Customer @record)
		{
			return db.GetTable<Customer>().Where(e => (bool)(e.CustomerId == @record.CustomerId));
		}

		public static EmployeeTerritory? Find(this ITable<EmployeeTerritory> table, SqlInt32 employeeId, SqlString territoryId)
		{
			return table.FirstOrDefault(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId), cancellationToken);
		}
		...
		{
			return table.Where(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId));
		}

		public static EmployeeTerritory? Find(this ITable<EmployeeTerritory> table, EmployeeTerritory @record)
		{
			return table.FirstOrDefault(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId), cancellationToken);
		}

		public static IQueryable<EmployeeTerritory> FindQuery(this ITable<EmployeeTerritory> table, EmployeeTerritory @record)
		{
			return table.Where(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId));
		}

		public static EmployeeTerritory? FindEmployeeTerritory(this TestDataDB db, SqlInt32 employeeId, SqlString territoryId)
		{
			return db.GetTable<EmployeeTerritory>().FirstOrDefault(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId));
		}
		...
		{
			return db.GetTable<EmployeeTerritory>().FirstOrDefaultAsync(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId), cancellationToken);
		}
		...
		{
			return db.GetTable<EmployeeTerritory>().Where(e => (bool)(e.EmployeeId == employeeId) && (bool)(e.TerritoryId == territoryId));
		}

		public static EmployeeTerritory? Find(this TestDataDB db, EmployeeTerritory @record)
		{
			return db.GetTable<EmployeeTerritory>().FirstOrDefault(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId));
		}
		...
		{
			return db.GetTable<EmployeeTerritory>().FirstOrDefaultAsync(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId), cancellationToken);
		}

		public static IQueryable<EmployeeTerritory> FindQuery(this TestDataDB db, EmployeeTerritory @record)
		{
			return db.GetTable<EmployeeTerritory>().Where(e => (bool)(e.EmployeeId == @record.EmployeeId) && (bool)(e.TerritoryId == @record.TerritoryId));
		}

		public static Employee? Find(this ITable<Employee> table, SqlInt32 employeeId)
		{
			return table.FirstOrDefault(e => (bool)(e.EmployeeId == employeeId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.EmployeeId == employeeId), cancellationToken);
		}

		public static IQueryable<Employee> FindQuery(this ITable<Employee> table, SqlInt32 employeeId)
		{
			return table.Where(e => (bool)(e.EmployeeId == employeeId));
		}

		public static Employee? Find(this ITable<Employee> table, Employee @record)
		{
			return table.FirstOrDefault(e => (bool)(e.EmployeeId == @record.EmployeeId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.EmployeeId == @record.EmployeeId), cancellationToken);
		}

		public static IQueryable<Employee> FindQuery(this ITable<Employee> table, Employee @record)
		{
			return table.Where(e => (bool)(e.EmployeeId == @record.EmployeeId));
		}

		public static Employee? FindEmployee(this TestDataDB db, SqlInt32 employeeId)
		{
			return db.GetTable<Employee>().FirstOrDefault(e => (bool)(e.EmployeeId == employeeId));
		}
		...
		{
			return db.GetTable<Employee>().FirstOrDefaultAsync(e => (bool)(e.EmployeeId == employeeId), cancellationToken);
		}

		public static IQueryable<Employee> FindEmployeeQuery(this TestDataDB db, SqlInt32 employeeId)
		{
			return db.GetTable<Employee>().Where(e => (bool)(e.EmployeeId == employeeId));
		}

		public static Employee? Find(this TestDataDB db, Employee @record)
		{
			return db.GetTable<Employee>().FirstOrDefault(e => (bool)(e.EmployeeId == @record.EmployeeId));
		}

		public static Task<Employee?> FindAsync(this TestDataDB db, Employee @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Employee>().FirstOrDefaultAsync(e => (bool)(e.EmployeeId == @record.EmployeeId), cancellationToken);
		}

		public static IQueryable<Employee> FindQuery(this TestDataDB db, Employee @record)
		{
			return db.GetTable<Employee>().Where(e => (bool)(e.EmployeeId == @record.EmployeeId));
		}

		public static OrderDetail? Find(this ITable<OrderDetail> table, SqlInt32 orderId, SqlInt32 productId)
		{
			return table.FirstOrDefault(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId), cancellationToken);
		}

		public static IQueryable<OrderDetail> FindQuery(this ITable<OrderDetail> table, SqlInt32 orderId, SqlInt32 productId)
		{
			return table.Where(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId));
		}

		public static OrderDetail? Find(this ITable<OrderDetail> table, OrderDetail @record)
		{
			return table.FirstOrDefault(e => (bool)(e.OrderId == @record.OrderId) && (bool)(e.ProductId == @record.ProductId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.OrderId == @record.OrderId) && (bool)(e.ProductId == @record.ProductId), cancellationToken);
		}

		public static IQueryable<OrderDetail> FindQuery(this ITable<OrderDetail> table, OrderDetail @record)
		{
			return table.Where(e => (bool)(e.OrderId == @record.OrderId) && (bool)(e.ProductId == @record.ProductId));
		}

		public static OrderDetail? FindOrderDetail(this TestDataDB db, SqlInt32 orderId, SqlInt32 productId)
		{
			return db.GetTable<OrderDetail>().FirstOrDefault(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId));
		}
		...
		{
			return db.GetTable<OrderDetail>().FirstOrDefaultAsync(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId), cancellationToken);
		}

		public static IQueryable<OrderDetail> FindOrderDetailQuery(this TestDataDB db, SqlInt32 orderId, SqlInt32 productId)
		{
			return db.GetTable<OrderDetail>().Where(e => (bool)(e.OrderId == orderId) && (bool)(e.ProductId == productId));
		}

		public static OrderDetail? Find(this TestDataDB db, OrderDetail @record)
		{
			return db.GetTable<OrderDetail>().FirstOrDefault(e => (bool)(e.OrderId == @record.OrderId) && (bool)(e.ProductId == @record.ProductId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.ProductId == productId), cancellationToken);
		}

		public static IQueryable<Product> FindQuery(this ITable<Product> table, SqlInt32 productId)
		{
			return table.Where(e => (bool)(e.ProductId == productId));
		}

		public static Product? Find(this ITable<Product> table, Product @record)
		{
			return table.FirstOrDefault(e => (bool)(e.ProductId == @record.ProductId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.ProductId == @record.ProductId), cancellationToken);
		}

		public static IQueryable<Product> FindQuery(this ITable<Product> table, Product @record)
		{
			return table.Where(e => (bool)(e.ProductId == @record.ProductId));
		}

		public static Product? FindProduct(this TestDataDB db, SqlInt32 productId)
		{
			return db.GetTable<Product>().FirstOrDefault(e => (bool)(e.ProductId == productId));
		}
		...
		{
			return db.GetTable<Product>().FirstOrDefaultAsync(e => (bool)(e.ProductId == productId), cancellationToken);
		}

		public static IQueryable<Product> FindProductQuery(this TestDataDB db, SqlInt32 productId)
		{
			return db.GetTable<Product>().Where(e => (bool)(e.ProductId == productId));
		}

		public static Product? Find(this TestDataDB db, Product @record)
		{
			return db.GetTable<Product>().FirstOrDefault(e => (bool)(e.ProductId == @record.ProductId));
		}

		public static Task<Product?> FindAsync(this TestDataDB db, Product @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Product>().FirstOrDefaultAsync(e => (bool)(e.ProductId == @record.ProductId), cancellationToken);
		}

		public static IQueryable<Product> FindQuery(this TestDataDB db, Product @record)
		{
			return db.GetTable<Product>().Where(e => (bool)(e.ProductId == @record.ProductId));
		}

		public static Region? Find(this ITable<Region> table, SqlInt32 regionId)
		{
			return table.FirstOrDefault(e => (bool)(e.RegionId == regionId));
		}
		...
		{
			return db.GetTable<Region>().FirstOrDefaultAsync(e => (bool)(e.RegionId == regionId), cancellationToken);
		}

		public static IQueryable<Region> FindRegionQuery(this TestDataDB db, SqlInt32 regionId)
		{
			return db.GetTable<Region>().Where(e => (bool)(e.RegionId == regionId));
		}

		public static Region? Find(this TestDataDB db, Region @record)
		{
			return db.GetTable<Region>().FirstOrDefault(e => (bool)(e.RegionId == @record.RegionId));
		}

		public static Task<Region?> FindAsync(this TestDataDB db, Region @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Region>().FirstOrDefaultAsync(e => (bool)(e.RegionId == @record.RegionId), cancellationToken);
		}

		public static IQueryable<Region> FindQuery(this TestDataDB db, Region @record)
		{
			return db.GetTable<Region>().Where(e => (bool)(e.RegionId == @record.RegionId));
		}

		public static Shipper? Find(this ITable<Shipper> table, SqlInt32 shipperId)
		{
			return table.FirstOrDefault(e => (bool)(e.ShipperId == shipperId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.ShipperId == shipperId), cancellationToken);
		}

		public static IQueryable<Shipper> FindQuery(this ITable<Shipper> table, SqlInt32 shipperId)
		{
			return table.Where(e => (bool)(e.ShipperId == shipperId));
		}

		public static Shipper? Find(this ITable<Shipper> table, Shipper @record)
		{
			return table.FirstOrDefault(e => (bool)(e.ShipperId == @record.ShipperId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.ShipperId == @record.ShipperId), cancellationToken);
		}

		public static IQueryable<Shipper> FindQuery(this ITable<Shipper> table, Shipper @record)
		{
			return table.Where(e => (bool)(e.ShipperId == @record.ShipperId));
		}

		public static Shipper? FindShipper(this TestDataDB db, SqlInt32 shipperId)
		{
			return db.GetTable<Shipper>().FirstOrDefault(e => (bool)(e.ShipperId == shipperId));
		}
		...
		{
			return db.GetTable<Shipper>().FirstOrDefaultAsync(e => (bool)(e.ShipperId == shipperId), cancellationToken);
		}

		public static IQueryable<Shipper> FindShipperQuery(this TestDataDB db, SqlInt32 shipperId)
		{
			return db.GetTable<Shipper>().Where(e => (bool)(e.ShipperId == shipperId));
		}

		public static Shipper? Find(this TestDataDB db, Shipper @record)
		{
			return db.GetTable<Shipper>().FirstOrDefault(e => (bool)(e.ShipperId == @record.ShipperId));
		}

		public static Task<Shipper?> FindAsync(this TestDataDB db, Shipper @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Shipper>().FirstOrDefaultAsync(e => (bool)(e.ShipperId == @record.ShipperId), cancellationToken);
		}

		public static IQueryable<Shipper> FindQuery(this TestDataDB db, Shipper @record)
		{
			return db.GetTable<Shipper>().Where(e => (bool)(e.ShipperId == @record.ShipperId));
		}

		public static Supplier? Find(this ITable<Supplier> table, SqlInt32 supplierId)
		{
			return table.FirstOrDefault(e => (bool)(e.SupplierId == supplierId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.SupplierId == supplierId), cancellationToken);
		}

		public static IQueryable<Supplier> FindQuery(this ITable<Supplier> table, SqlInt32 supplierId)
		{
			return table.Where(e => (bool)(e.SupplierId == supplierId));
		}

		public static Supplier? Find(this ITable<Supplier> table, Supplier @record)
		{
			return table.FirstOrDefault(e => (bool)(e.SupplierId == @record.SupplierId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.SupplierId == @record.SupplierId), cancellationToken);
		}

		public static IQueryable<Supplier> FindQuery(this ITable<Supplier> table, Supplier @record)
		{
			return table.Where(e => (bool)(e.SupplierId == @record.SupplierId));
		}

		public static Supplier? FindSupplier(this TestDataDB db, SqlInt32 supplierId)
		{
			return db.GetTable<Supplier>().FirstOrDefault(e => (bool)(e.SupplierId == supplierId));
		}
		...
		{
			return db.GetTable<Supplier>().FirstOrDefaultAsync(e => (bool)(e.SupplierId == supplierId), cancellationToken);
		}

		public static IQueryable<Supplier> FindSupplierQuery(this TestDataDB db, SqlInt32 supplierId)
		{
			return db.GetTable<Supplier>().Where(e => (bool)(e.SupplierId == supplierId));
		}

		public static Supplier? Find(this TestDataDB db, Supplier @record)
		{
			return db.GetTable<Supplier>().FirstOrDefault(e => (bool)(e.SupplierId == @record.SupplierId));
		}

		public static Task<Supplier?> FindAsync(this TestDataDB db, Supplier @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Supplier>().FirstOrDefaultAsync(e => (bool)(e.SupplierId == @record.SupplierId), cancellationToken);
		}

		public static IQueryable<Supplier> FindQuery(this TestDataDB db, Supplier @record)
		{
			return db.GetTable<Supplier>().Where(e => (bool)(e.SupplierId == @record.SupplierId));
		}

		public static Territory? Find(this ITable<Territory> table, SqlString territoryId)
		{
			return table.FirstOrDefault(e => (bool)(e.TerritoryId == territoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.TerritoryId == territoryId), cancellationToken);
		}

		public static IQueryable<Territory> FindQuery(this ITable<Territory> table, SqlString territoryId)
		{
			return table.Where(e => (bool)(e.TerritoryId == territoryId));
		}

		public static Territory? Find(this ITable<Territory> table, Territory @record)
		{
			return table.FirstOrDefault(e => (bool)(e.TerritoryId == @record.TerritoryId));
		}
		...
		{
			return table.FirstOrDefaultAsync(e => (bool)(e.TerritoryId == @record.TerritoryId), cancellationToken);
		}

		public static IQueryable<Territory> FindQuery(this ITable<Territory> table, Territory @record)
		{
			return table.Where(e => (bool)(e.TerritoryId == @record.TerritoryId));
		}

		public static Territory? FindTerritory(this TestDataDB db, SqlString territoryId)
		{
			return db.GetTable<Territory>().FirstOrDefault(e => (bool)(e.TerritoryId == territoryId));
		}
		...
		{
			return db.GetTable<Territory>().FirstOrDefaultAsync(e => (bool)(e.TerritoryId == territoryId), cancellationToken);
		}

		public static IQueryable<Territory> FindTerritoryQuery(this TestDataDB db, SqlString territoryId)
		{
			return db.GetTable<Territory>().Where(e => (bool)(e.TerritoryId == territoryId));
		}

		public static Territory? Find(this TestDataDB db, Territory @record)
		{
			return db.GetTable<Territory>().FirstOrDefault(e => (bool)(e.TerritoryId == @record.TerritoryId));
		}

		public static Task<Territory?> FindAsync(this TestDataDB db, Territory @record, CancellationToken cancellationToken = default)
		{
			return db.GetTable<Territory>().FirstOrDefaultAsync(e => (bool)(e.TerritoryId == @record.TerritoryId), cancellationToken);
		}

		public static IQueryable<Territory> FindQuery(this TestDataDB db, Territory @record)
		{
			return db.GetTable<Territory>().Where(e => (bool)(e.TerritoryId == @record.TerritoryId));
		}
		#endregion
		...
		{
			return db.GetTable<CustomerDemographic>().First(t => (bool)(obj.CustomerTypeId == t.CustomerTypeId));
		}
		...
		{
			return db.GetTable<Customer>().First(t => (bool)(obj.CustomerId == t.CustomerId));
		}
		#endregion
		...
		{
			return db.GetTable<CustomerCustomerDemo>().Where(t => (bool)(t.CustomerTypeId == obj.CustomerTypeId));
		}
		#endregion
		...
		{
			return db.GetTable<CustomerCustomerDemo>().Where(t => (bool)(t.CustomerId == obj.CustomerId));
		}
		...
		{
			return db.GetTable<EmployeeTerritory>().Where(t => (bool)(t.EmployeeId == obj.EmployeeId));
		}
		...
		{
			return db.GetTable<Employee>().First(t => (bool)(obj.EmployeeId == t.EmployeeId));
		}
		...
		{
			return db.GetTable<Territory>().First(t => (bool)(obj.TerritoryId == t.TerritoryId));
		}
		#endregion
		...
		{
			return db.GetTable<EmployeeTerritory>().Where(t => (bool)(t.TerritoryId == obj.TerritoryId));
		}
		...
		{
			return db.GetTable<Region>().First(t => (bool)(obj.RegionId == t.RegionId));
		}
		#endregion
		...
		{
			return db.GetTable<Order>().First(t => (bool)(obj.OrderId == t.OrderId));
		}
		...
		{
			return db.GetTable<Product>().First(t => (bool)(obj.ProductId == t.ProductId));
		}
		#endregion
		...
		{
			return db.GetTable<OrderDetail>().Where(t => (bool)(t.OrderId == obj.OrderId));
		}
		...
		{
			return db.GetTable<OrderDetail>().Where(t => (bool)(t.ProductId == obj.ProductId));
		}
		...
		{
			return db.GetTable<Territory>().Where(t => (bool)(t.RegionId == obj.RegionId));
		}
		#endregion
		#endregion
