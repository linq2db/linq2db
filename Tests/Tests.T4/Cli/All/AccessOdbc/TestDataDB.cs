...
namespace Cli.All.Access.Odbc
{
	...
	public static partial class ExtensionMethods
	{
		...
		public partial class PatientSelectByNameResult
		{
			...
			[Column("FirstName" , DataType = DataType.VarChar, DbType = "VARCHAR(255)")] public string? FirstName  { get; set; }
			[Column("LastName"  , DataType = DataType.VarChar, DbType = "VARCHAR(255)")] public string? LastName   { get; set; }
			[Column("MiddleName", DataType = DataType.VarChar, DbType = "VARCHAR(255)")] public string? MiddleName { get; set; }
			[Column("Gender"    , DataType = DataType.VarChar, DbType = "VARCHAR(255)")] public string? Gender     { get; set; }
