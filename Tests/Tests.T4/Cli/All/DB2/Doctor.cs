...
namespace Cli.All.DB2
{
	...
	{
		[Column("PersonID", DataType = DataType.Int32  , DbType = "INTEGER"    , IsPrimaryKey = true)] public DB2Int32  PersonId { get; set; } // INTEGER
		[Column("Taxonomy", DataType = DataType.VarChar, DbType = "VARCHAR(50)", Length       = 50  )] public DB2String Taxonomy { get; set; } // VARCHAR(50)
