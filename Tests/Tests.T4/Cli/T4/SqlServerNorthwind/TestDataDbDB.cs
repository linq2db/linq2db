...
namespace Cli.T4.SqlServerNorthwind
{
	...
	public static partial class ExtensionMethods
	{
		...
		public static IEnumerable<CustOrderHistResult> CustOrderHist(this TestDataDbDB dataConnection, string? customerId)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<CustOrdersDetailResult> CustOrdersDetail(this TestDataDbDB dataConnection, int? orderId)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<CustOrdersOrdersResult> CustOrdersOrders(this TestDataDbDB dataConnection, string? customerId)
		{
			var parameters = new []
			{
				new DataParameter("@CustomerID", customerId, DataType.NChar)
		...
		public static IEnumerable<EmployeeSalesByCountryResult> EmployeeSalesByCountry(this TestDataDbDB dataConnection, DateTime? beginningDate, DateTime? endingDate)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<SalesByYearResult> SalesByYear(this TestDataDbDB dataConnection, DateTime? beginningDate, DateTime? endingDate)
		{
			var parameters = new []
			{
				new DataParameter("@Beginning_Date", beginningDate, DataType.DateTime),
		...
		public static IEnumerable<SalesByCategoryResult> SalesByCategory(this TestDataDbDB dataConnection, string? categoryName, string? ordYear)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<TenMostExpensiveProductsResult> TenMostExpensiveProducts(this TestDataDbDB dataConnection)
		{
