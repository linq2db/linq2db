...
namespace Cli.T4.Access.LibRed
{
	...
	{
		[Column("ID"                      , IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int       ID                       { get; set; } // Long
	...
	{
		[Column("DataTypeID", IsPrimaryKey = true, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int       DataTypeID { get; set; } // Long
	...
	{
		[Column("PersonID"  , IsPrimaryKey = true , IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int     PersonID   { get; set; } // Long
		...
		/// </summary>
		[Association(ThisKey = nameof(PersonID), OtherKey = nameof(LibRed.Doctor.PersonID))]
		public Doctor? Doctor { get; set; }

		/// <summary>
		/// PersonPatient backreference
		/// </summary>
		[Association(ThisKey = nameof(PersonID), OtherKey = nameof(LibRed.Patient.PersonID))]
	...
	{
		[Column("ID", IsPrimaryKey = true, IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int ID { get; set; } // Long
	}
	...
	{
		[Column("PersonID"  , IsIdentity = true, SkipOnInsert = true, SkipOnUpdate = true)] public int     PersonID   { get; set; } // Long
	...
	public partial class ScalarDataReader
	{
		...
		[Column("stringField")] public string? StringField { get; set; } // VarChar(0)
	}
}
