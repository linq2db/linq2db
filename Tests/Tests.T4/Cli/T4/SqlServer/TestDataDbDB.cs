...
namespace Cli.T4.SqlServer
{
	public partial class TestDataDbDB : DataConnection
	{
		...
		#region Issue1921
		private static readonly MethodInfo _issue1921 = MemberHelper.MethodOf<TestDataDbDB>(ctx => ctx.Issue1921());
	...
	public static partial class ExtensionMethods
	{
		...
		public static int ExecuteProcIntParameters(this TestDataDbDB dataConnection, int? input, ref int? output)
		{
			var parameters = new []
			{
		...
		/// </param>
		public static IEnumerable<ExecuteProcStringParametersResult> ExecuteProcStringParameters(this TestDataDbDB dataConnection, int? input, ref int? output)
		{
			var parameters = new []
			{
				new DataParameter("@input", input, LinqToDB.DataType.Int32),
		...
		#region Issue1897
		public static int Issue1897(this TestDataDbDB dataConnection)
		{
		...
		public static int OutRefEnumTest(this TestDataDbDB dataConnection, string? str, ref string? outputStr, ref string? inputOutputStr)
		{
			var parameters = new []
			{
		...
		#region OutRefTest
		public static int OutRefTest(this TestDataDbDB dataConnection, int? id, ref int? outputId, ref int? inputOutputId, string? str, ref string? outputStr, ref string? inputOutputStr)
		{
			var parameters = new []
			{
		...
		#region PersonInsert
		public static IEnumerable<PersonInsertResult> PersonInsert(this TestDataDbDB dataConnection, string? firstName, string? lastName, string? middleName, char? gender)
		{
			var parameters = new []
			{
				new DataParameter("@FirstName", firstName, LinqToDB.DataType.NVarChar)
		...
		public static int PersonInsertOutputParameter(this TestDataDbDB dataConnection, string? firstName, string? lastName, string? middleName, char? gender, ref int? personId)
		{
			var parameters = new []
			{
				new DataParameter("@FirstName", firstName, LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<PersonSelectByKeyLowercaseResult> PersonSelectByKeyLowercase(this TestDataDbDB dataConnection, int? id)
		{
			var parameters = new []
			{
				new DataParameter("@id", id, LinqToDB.DataType.Int32)
		...
		public static IEnumerable<QueryProcMultipleParametersResult> QueryProcMultipleParameters(this TestDataDbDB dataConnection, int? input, ref int? output1, ref int? output2, ref int? output3)
		{
			var parameters = new []
			{
				new DataParameter("@input", input, LinqToDB.DataType.Int32),
		...
		public static IEnumerable<QueryProcParametersResult> QueryProcParameters(this TestDataDbDB dataConnection, int? input, ref int? output1, ref int? output2)
		{
			var parameters = new []
			{
				new DataParameter("@input", input, LinqToDB.DataType.Int32),
		...
		public static IEnumerable<TableTypeTestProcResult> TableTypeTestProc(this TestDataDbDB dataConnection, DataTable? table)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<TestProcedureResult> TestProcedure(this TestDataDbDB dataConnection)
		{
		...
		public static IEnumerable<VariableResultsResult> VariableResults(this TestDataDbDB dataConnection, bool? returnFullRow)
		{
			var parameters = new []
			{
