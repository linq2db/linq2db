...
namespace Cli.T4.PostgreSQL
{
	public partial class TestDataDbDB : DataConnection
	{
		...
		private static readonly MethodInfo _testTableFunction = MemberHelper.MethodOf<TestDataDbDB>(ctx => ctx.TestTableFunction(default));
		...
		private static readonly MethodInfo _testTableFunction1 = MemberHelper.MethodOf<TestDataDbDB>(ctx => ctx.TestTableFunction1(default, default));
		...
		private static readonly MethodInfo _testTableFunctionSchema = MemberHelper.MethodOf<TestDataDbDB>(ctx => ctx.TestTableFunctionSchema());
