...
namespace Cli.T4.Firebird
{
	...
	public static partial class ExtensionMethods
	{
		...
		public static IEnumerable<OutRefEnumTestResult> OutRefEnumTest(this TestDataDbDB dataConnection, string? str, string? inInputoutputstr)
		{
			var parameters = new []
			{
		...
		#region OutRefTest
		public static IEnumerable<OutRefTestResult> OutRefTest(this TestDataDbDB dataConnection, int? id, int? inInputoutputid, string? str, string? inInputoutputstr)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<PersonInsertOutputParameterResult> PersonInsertOutputParameter(this TestDataDbDB dataConnection, string? firstname, string? lastname, string? middlename, char? gender)
		{
			var parameters = new []
			{
				new DataParameter("FIRSTNAME", firstname, DataType.NVarChar)
		...
		public static IEnumerable<PersonSelectByNameResult> PersonSelectByName(this TestDataDbDB dataConnection, string? inFirstname, string? inLastname)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<ScalarDataReaderResult> ScalarDataReader(this TestDataDbDB dataConnection)
		{
		...
		public static IEnumerable<ScalarOutputParameterResult> ScalarOutputParameter(this TestDataDbDB dataConnection)
		{
		...
		public static IEnumerable<ScalarReturnParameterResult> ScalarReturnParameter(this TestDataDbDB dataConnection)
		{
		...
		#region TestV4Types
		public static IEnumerable<TestV4TypesResult> TestV4Types(this TestDataDbDB dataConnection, FbZonedDateTime? tstz, FbZonedTime? ttz, FbDecFloat? decfloat16, FbDecFloat? decfloat34, BigInteger? int128)
		{
			var parameters = new []
			{
