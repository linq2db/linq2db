...
namespace Cli.T4.Sybase
{
	...
	public static partial class ExtensionMethods
	{
		...
		public static int AddIssue792Record(this TestDataDbDB dataConnection, out int? returnValue)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<PersonSelectAllResult> PersonSelectAll(this TestDataDbDB dataConnection, out int? returnValue)
		{
			var parameters = new []
			{
				new DataParameter("RETURN_VALUE", null, DataType.Int32)
