...
namespace Cli.T4.Oracle
{
	...
	public static partial class ExtensionMethods
	{
		...
		#region PersonUpdate
		public static int PersonUpdate(this TestDataDbDB dataConnection, decimal? ppersonid, string? pfirstname, string? plastname, string? pmiddlename, string? pgender)
		{
			var parameters = new []
			{
		...
		#region PersonDelete
		public static int PersonDelete(this TestDataDbDB dataConnection, decimal? ppersonid)
		{
			var parameters = new []
			{
				new DataParameter("PPERSONID", ppersonid, DataType.Decimal)
		...
		#region Outreftest
		public static int Outreftest(this TestDataDbDB dataConnection, decimal? pid, out decimal? poutputid, ref decimal? pinputoutputid, string? pstr, out string? poutputstr, ref string? pinputoutputstr)
		{
			var parameters = new []
			{
		...
		public static int Outrefenumtest(this TestDataDbDB dataConnection, string? pstr, out string? poutputstr, ref string? pinputoutputstr)
		{
			var parameters = new []
			{
				new DataParameter("PSTR", pstr, DataType.NVarChar),
