...
namespace Cli.NoMetadata.Informix
{
	public class Linqdatatype
	{
		...
		public DateTime? Datetimevalue  { get; set; } // DATETIME YEAR TO FRACTION(3)
		public DateTime? Datetimevalue2 { get; set; } // DATETIME YEAR TO FRACTION(3)
		public bool?     Boolvalue      { get; set; } // BOOLEAN
		public string?   Guidvalue      { get; set; } // CHAR(36)
		public byte[]?   Binaryvalue    { get; set; } // BYTE
