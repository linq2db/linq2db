...
namespace Cli.Default.SqlCe
{
	...
	public static partial class ExtensionMethods
	{
		...
		public static Task<Issue695?> FindAsync(this ITable<Issue695> table, int id, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.Id == id, cancellationToken);
		}
		...
		public static Task<Issue695Parent?> FindAsync(this ITable<Issue695Parent> table, int id, CancellationToken cancellationToken = default)
		{
			return table.FirstOrDefaultAsync(e => e.Id == id, cancellationToken);
		}
