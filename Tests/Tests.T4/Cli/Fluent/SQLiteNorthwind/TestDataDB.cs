...
namespace Cli.Fluent.SQLiteNorthwind
{
	public partial class TestDataDB : DataConnection
	{
		static TestDataDB()
		{
			...
			{
				CanBeNull = false
			}).Member(e => e.Description).HasAttribute(new ColumnAttribute("Description")).Member(e => e.Picture).HasAttribute(new ColumnAttribute("Picture"));
			...
			fluentBuilder.Entity<CustomerDemographic>().HasAttribute(new TableAttribute("CustomerDemographics")).Member(e => e.CustomerTypeId).HasAttribute(new ColumnAttribute("CustomerTypeID")
			{
				CanBeNull = false,
				IsPrimaryKey = true
			}).Member(e => e.CustomerDesc).HasAttribute(new ColumnAttribute("CustomerDesc"));
			...
			{
				CanBeNull = false
			}).Member(e => e.ContactName).HasAttribute(new ColumnAttribute("ContactName")).Member(e => e.ContactTitle).HasAttribute(new ColumnAttribute("ContactTitle")).Member(e => e.Address).HasAttribute(new ColumnAttribute("Address")).Member(e => e.City).HasAttribute(new ColumnAttribute("City")).Member(e => e.Region).HasAttribute(new ColumnAttribute("Region")).Member(e => e.PostalCode).HasAttribute(new ColumnAttribute("PostalCode")).Member(e => e.Country).HasAttribute(new ColumnAttribute("Country")).Member(e => e.Phone).HasAttribute(new ColumnAttribute("Phone")).Member(e => e.Fax).HasAttribute(new ColumnAttribute("Fax"));
			...
			{
				CanBeNull = false
			}).Member(e => e.Title).HasAttribute(new ColumnAttribute("Title")).Member(e => e.TitleOfCourtesy).HasAttribute(new ColumnAttribute("TitleOfCourtesy")).Member(e => e.BirthDate).HasAttribute(new ColumnAttribute("BirthDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.HireDate).HasAttribute(new ColumnAttribute("HireDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.Address).HasAttribute(new ColumnAttribute("Address")).Member(e => e.City).HasAttribute(new ColumnAttribute("City")).Member(e => e.Region).HasAttribute(new ColumnAttribute("Region")).Member(e => e.PostalCode).HasAttribute(new ColumnAttribute("PostalCode")).Member(e => e.Country).HasAttribute(new ColumnAttribute("Country")).Member(e => e.HomePhone).HasAttribute(new ColumnAttribute("HomePhone")).Member(e => e.Extension).HasAttribute(new ColumnAttribute("Extension")).Member(e => e.Photo).HasAttribute(new ColumnAttribute("Photo")).Member(e => e.Notes).HasAttribute(new ColumnAttribute("Notes")).Member(e => e.ReportsTo).HasAttribute(new ColumnAttribute("ReportsTo")).Member(e => e.PhotoPath).HasAttribute(new ColumnAttribute("PhotoPath"));
			...
			}).Member(e => e.ProductId).HasAttribute(new ColumnAttribute("ProductID")
			{
				IsPrimaryKey = true,
				PrimaryKeyOrder = 1
			}).Member(e => e.UnitPrice).HasAttribute(new ColumnAttribute("UnitPrice")).Member(e => e.Quantity).HasAttribute(new ColumnAttribute("Quantity")).Member(e => e.Discount).HasAttribute(new ColumnAttribute("Discount"));
			...
			{
				IsPrimaryKey = true
			}).Member(e => e.CustomerId).HasAttribute(new ColumnAttribute("CustomerID")).Member(e => e.EmployeeId).HasAttribute(new ColumnAttribute("EmployeeID")).Member(e => e.OrderDate).HasAttribute(new ColumnAttribute("OrderDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.RequiredDate).HasAttribute(new ColumnAttribute("RequiredDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.ShippedDate).HasAttribute(new ColumnAttribute("ShippedDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.ShipVia).HasAttribute(new ColumnAttribute("ShipVia")).Member(e => e.Freight).HasAttribute(new ColumnAttribute("Freight")).Member(e => e.ShipName).HasAttribute(new ColumnAttribute("ShipName")).Member(e => e.ShipAddress).HasAttribute(new ColumnAttribute("ShipAddress")).Member(e => e.ShipCity).HasAttribute(new ColumnAttribute("ShipCity")).Member(e => e.ShipRegion).HasAttribute(new ColumnAttribute("ShipRegion")).Member(e => e.ShipPostalCode).HasAttribute(new ColumnAttribute("ShipPostalCode")).Member(e => e.ShipCountry).HasAttribute(new ColumnAttribute("ShipCountry"));
			...
			{
				CanBeNull = false
			}).Member(e => e.SupplierId).HasAttribute(new ColumnAttribute("SupplierID")).Member(e => e.CategoryId).HasAttribute(new ColumnAttribute("CategoryID")).Member(e => e.QuantityPerUnit).HasAttribute(new ColumnAttribute("QuantityPerUnit")).Member(e => e.UnitPrice).HasAttribute(new ColumnAttribute("UnitPrice")).Member(e => e.UnitsInStock).HasAttribute(new ColumnAttribute("UnitsInStock")).Member(e => e.UnitsOnOrder).HasAttribute(new ColumnAttribute("UnitsOnOrder")).Member(e => e.ReorderLevel).HasAttribute(new ColumnAttribute("ReorderLevel")).Member(e => e.Discontinued).HasAttribute(new ColumnAttribute("Discontinued"));
			...
			{
				CanBeNull = false
			}).Member(e => e.Phone).HasAttribute(new ColumnAttribute("Phone"));
			...
			{
				CanBeNull = false
			}).Member(e => e.ContactName).HasAttribute(new ColumnAttribute("ContactName")).Member(e => e.ContactTitle).HasAttribute(new ColumnAttribute("ContactTitle")).Member(e => e.Address).HasAttribute(new ColumnAttribute("Address")).Member(e => e.City).HasAttribute(new ColumnAttribute("City")).Member(e => e.Region).HasAttribute(new ColumnAttribute("Region")).Member(e => e.PostalCode).HasAttribute(new ColumnAttribute("PostalCode")).Member(e => e.Country).HasAttribute(new ColumnAttribute("Country")).Member(e => e.Phone).HasAttribute(new ColumnAttribute("Phone")).Member(e => e.Fax).HasAttribute(new ColumnAttribute("Fax")).Member(e => e.HomePage).HasAttribute(new ColumnAttribute("HomePage"));
			...
			{
				CanBeNull = false
			}).Member(e => e.RegionId).HasAttribute(new ColumnAttribute("RegionID"));
			...
			{
				IsView = true
			}).Member(e => e.OrderId).HasAttribute(new ColumnAttribute("OrderID")).Member(e => e.CustomerId).HasAttribute(new ColumnAttribute("CustomerID")).Member(e => e.EmployeeId).HasAttribute(new ColumnAttribute("EmployeeID")).Member(e => e.OrderDate).HasAttribute(new ColumnAttribute("OrderDate")
			{
				SkipOnInsert = true,
				SkipOnUpdate = true
			}).Member(e => e.RequiredDate).HasAttribute(new ColumnAttribute("RequiredDate")
