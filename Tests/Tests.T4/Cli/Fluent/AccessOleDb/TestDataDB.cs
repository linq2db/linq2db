...
namespace Cli.Fluent.Access.OleDb
{
	public partial class TestDataDB : DataConnection
	{
		static TestDataDB()
		{
			...
			{
				CanBeNull = false
			}).Member(e => e.PersonDoctor).HasAttribute(new AssociationAttribute()
			{
				CanBeNull = false,
			...
			{
				CanBeNull = false
			}).Member(e => e.PersonPatient).HasAttribute(new AssociationAttribute()
			{
				CanBeNull = false,
			...
			fluentBuilder.HasAttribute<Doctor>(e => ExtensionMethods.PersonDoctor(e, default(IDataContext)!), new AssociationAttribute()
			{
				CanBeNull = false,
				ThisKey = nameof(Doctor.PersonId),
				OtherKey = nameof(Person.PersonId)
			...
			fluentBuilder.HasAttribute<Patient>(e => ExtensionMethods.PersonPatient(e, default(IDataContext)!), new AssociationAttribute()
			{
				CanBeNull = false,
				ThisKey = nameof(Patient.PersonId),
				OtherKey = nameof(Person.PersonId)
