...
namespace Cli.Fluent.ClickHouse.MySql
{
	public partial class TestDataDB : DataConnection
	{
		static TestDataDB()
		{
			...
			fluentBuilder.Entity<AllType>().HasAttribute(new TableAttribute("AllTypes")).Member(e => e.Id).HasAttribute(new ColumnAttribute("ID")
			{
				IsPrimaryKey = true,
				SkipOnUpdate = true
			}).Member(e => e.IntDataType).HasAttribute(new ColumnAttribute("intDataType")).Member(e => e.SmallintDataType).HasAttribute(new ColumnAttribute("smallintDataType")).Member(e => e.FloatDataType).HasAttribute(new ColumnAttribute("floatDataType")).Member(e => e.DoubleDataType).HasAttribute(new ColumnAttribute("doubleDataType")).Member(e => e.NcharDataType).HasAttribute(new ColumnAttribute("ncharDataType")).Member(e => e.Char20DataType).HasAttribute(new ColumnAttribute("char20DataType")).Member(e => e.VarcharDataType).HasAttribute(new ColumnAttribute("varcharDataType")).Member(e => e.CharDataType).HasAttribute(new ColumnAttribute("charDataType"));
			...
			fluentBuilder.Entity<CollatedTable>().HasAttribute(new TableAttribute("CollatedTable")).Member(e => e.Id).HasAttribute(new ColumnAttribute("Id")
			{
				IsPrimaryKey = true,
				SkipOnUpdate = true
			}).Member(e => e.CaseSensitive).HasAttribute(new ColumnAttribute("CaseSensitive")).Member(e => e.CaseInsensitive).HasAttribute(new ColumnAttribute("CaseInsensitive"));
