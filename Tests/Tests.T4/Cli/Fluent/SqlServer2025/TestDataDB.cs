		...
		static TestDataDB()
		{
			...
			builder
				.Entity<AllType>()
					...
					.Member(e => e.VectorDataType)
						.HasAttribute(new ColumnAttribute("vectorDataType"))
				...
				.Entity<IndexTable>()
					...
					.Member(e => e.IndexTable2)
						.HasAttribute(new AssociationAttribute()
						{
							...
							OtherKey = nameof(SqlServer2025.IndexTable2.PkField2) + "," + nameof(SqlServer2025.IndexTable2.PkField1)
						});
			...
			builder
				.Entity<IndexTable2>()
					...
					.Member(e => e.Patient2IndexTable)
						...
						{
							CanBeNull = false,
							ThisKey = nameof(SqlServer2025.IndexTable2.PkField2) + "," + nameof(SqlServer2025.IndexTable2.PkField1),
			...
			builder
				.Entity<TestSchemaX>()
					...
					.Member(e => e.TestSchemaY)
						.HasAttribute(new AssociationAttribute()
						{
							ThisKey = nameof(SqlServer2025.TestSchemaX.TestSchemaXid),
							OtherKey = nameof(SqlServer2025.TestSchemaY.TestSchemaXid)
						})
					.Member(e => e.TestSchemaY1)
						.HasAttribute(new AssociationAttribute()
						{
							ThisKey = nameof(SqlServer2025.TestSchemaX.TestSchemaXid),
							OtherKey = nameof(SqlServer2025.TestSchemaY.ParentTestSchemaXid)
						});
			...
			builder
				.Entity<TestSchemaY>()
					...
					.Member(e => e.TestSchemaX)
						...
						{
							CanBeNull = false,
							ThisKey = nameof(SqlServer2025.TestSchemaY.TestSchemaXid),
							OtherKey = nameof(SqlServer2025.TestSchemaX.TestSchemaXid)
						})
					.Member(e => e.ParentTestSchemaX)
						.HasAttribute(new AssociationAttribute()
						{
							CanBeNull = false,
							ThisKey = nameof(SqlServer2025.TestSchemaY.ParentTestSchemaXid),
							OtherKey = nameof(SqlServer2025.TestSchemaX.TestSchemaXid)
						});
