...
namespace MariaDB
{
	...
	public partial class CollatedTable
	{
		...
		[Column, NotNull] public string CaseSensitive   { get; set; } // varchar(20)
		[Column, NotNull] public string CaseInsensitive { get; set; } // varchar(20)
	}
	...
	public partial class Doctor
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MariaDB.Person.PersonID), CanBeNull=false)]
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MariaDB.Doctor.PersonID), CanBeNull=true)]
		public Doctor Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(MariaDB.Patient.PersonID), CanBeNull=true)]
