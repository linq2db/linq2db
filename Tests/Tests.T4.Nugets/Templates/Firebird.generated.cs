...
namespace Firebird
{
	public partial class Testdb50DB : LinqToDB.Data.DataConnection
	{
		#region Tables
		...
		public Testdb50DB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Testdb50DB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Testdb50DB(DataOptions<Testdb50DB> options)
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Firebird.Doctor.PersonID), CanBeNull=true)]
	...
	{
		[Column(),         PrimaryKey, NotNull] public int    ID    { get; set; } // integer
		[Column("Value_"),             NotNull] public string Value { get; set; } // varchar(50)
	}
	...
	public static partial class Testdb50DBStoredProcedures
	{
		#region AddIssue792Record

		public static int AddIssue792Record(this Testdb50DB dataConnection)
		{
		...
		public static int PersonDelete(this Testdb50DB dataConnection, int? personID)
		{
			var parameters = new []
			{
		...
		public static int PersonUpdate(this Testdb50DB dataConnection, int? personid, string firstname, string lastname, string middlename, char? gender)
		{
			var parameters = new []
			{
				new DataParameter("PERSONID",   personid,   LinqToDB.DataType.Int32, 4),
		...
		public static int TestPACKAGE1TestProcedure(this Testdb50DB dataConnection, int? i, out int? o)
		{
			var parameters = new []
			{
		...
		public static int TestPACKAGE2TestProcedure(this Testdb50DB dataConnection, int? i, out int? o)
		{
			var parameters = new []
			{
				new DataParameter("I", i, LinqToDB.DataType.Int32, 4),
		...
		public static int TestProcedure(this Testdb50DB dataConnection, int? i, out int? o)
		{
			var parameters = new []
			{
				new DataParameter("I", i, LinqToDB.DataType.Int32, 4),
