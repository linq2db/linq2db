...
namespace SqlServer
{
	...
	public partial class Doctor
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(SqlServer.Person.PersonID), CanBeNull=false)]
	...
	public partial class IndexTable
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PKField2) + ", " + nameof(PKField1), OtherKey=nameof(SqlServer.IndexTable2.PKField2) + ", " + nameof(SqlServer.IndexTable2.PKField1), CanBeNull=true)]
	...
	public partial class IndexTable2
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PKField2) + ", " + nameof(PKField1), OtherKey=nameof(SqlServer.IndexTable.PKField2) + ", " + nameof(SqlServer.IndexTable.PKField1), CanBeNull=false)]
	...
	public partial class Member
	{
		...
		[Column,     NotNull ] public string Alias    { get; set; } // nvarchar(50)
		...
		/// </summary>
		[Association(ThisKey=nameof(MemberId), OtherKey=nameof(SqlServer.Provider.ProviderId), CanBeNull=true)]
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(SqlServer.Doctor.PersonID), CanBeNull=true)]
		public Doctor Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (dbo.Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(SqlServer.Patient.PersonID), CanBeNull=true)]
	...
	public partial class Provider
	{
		...
		[Column,     NotNull] public string Test       { get; set; } // nvarchar(max)
		...
		/// </summary>
		[Association(ThisKey=nameof(ProviderId), OtherKey=nameof(SqlServer.Member.MemberId), CanBeNull=false)]
	...
	public partial class TestSchemaX
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(SqlServer.TestSchemaY.TestSchemaXID), CanBeNull=true)]
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(SqlServer.TestSchemaY.ParentTestSchemaXID), CanBeNull=true)]
	...
	public partial class TestSchemaY
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(TestSchemaXID), OtherKey=nameof(SqlServer.TestSchemaX.TestSchemaXID), CanBeNull=false)]
		public TestSchemaX FkTestSchemaYOtherID { get; set; }

		/// <summary>
		/// FK_TestSchemaY_ParentTestSchemaX (dbo.TestSchemaX)
		/// </summary>
		[Association(ThisKey=nameof(ParentTestSchemaXID), OtherKey=nameof(SqlServer.TestSchemaX.TestSchemaXID), CanBeNull=false)]
	...
	public static partial class TestSchemaSchema
	{
		...
		public partial class TestSchemaA
		{
			...
			/// </summary>
			[Association(ThisKey=nameof(TestSchemaAID), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaB.TargetTestSchemaAId), CanBeNull=true)]
			public IEnumerable<TestSchemaSchema.TestSchemaB> FkTestSchemaTestSchemaBYTargetTestSchemaA2BackReferences { get; set; }

			/// <summary>
			/// FK_TestSchema_TestSchemaBY_OriginTestSchemaA_BackReference (TestSchema.TestSchemaB)
			/// </summary>
			[Association(ThisKey=nameof(TestSchemaAID), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaB.OriginTestSchemaAID), CanBeNull=true)]
			public IEnumerable<TestSchemaSchema.TestSchemaB> TestSchemaBYOriginTestSchemaA { get; set; }

			/// <summary>
			/// FK_TestSchema_TestSchemaBY_TargetTestSchemaA_BackReference (TestSchema.TestSchemaB)
			/// </summary>
			[Association(ThisKey=nameof(TestSchemaAID), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaB.TargetTestSchemaAID), CanBeNull=true)]
			public IEnumerable<TestSchemaSchema.TestSchemaB> TestSchemaBYTargetTestSchemaA { get; set; }
		...
		public partial class TestSchemaB
		{
			...
			/// </summary>
			[Association(ThisKey=nameof(TargetTestSchemaAID), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaA.TestSchemaAID), CanBeNull=false)]
			public TestSchemaSchema.TestSchemaA FKTargetTestSchemaA { get; set; }

			/// <summary>
			/// FK_TestSchema_TestSchemaBY_OriginTestSchemaA (TestSchema.TestSchemaA)
			/// </summary>
			[Association(ThisKey=nameof(OriginTestSchemaAID), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaA.TestSchemaAID), CanBeNull=false)]
			public TestSchemaSchema.TestSchemaA OriginTestSchemaA { get; set; }

			/// <summary>
			/// FK_TestSchema_TestSchemaBY_TargetTestSchemaA2 (TestSchema.TestSchemaA)
			/// </summary>
			[Association(ThisKey=nameof(TargetTestSchemaAId), OtherKey=nameof(SqlServer.TestSchemaSchema.TestSchemaA.TestSchemaAID), CanBeNull=false)]
			public TestSchemaSchema.TestSchemaA TargetTestSchemaA { get; set; }
		...
		public static IEnumerable<TestProcedureResult> TestProcedure(TestDataDB dataConnection)
		{
			var ms = dataConnection.MappingSchema;
