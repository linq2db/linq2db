...
namespace Access.OleDb
{
	...
	public partial class Doctor
	{
		...
		/// PersonDoctor (Person)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Access.OleDb.Person.PersonID), CanBeNull=false)]
	...
	{
		[PrimaryKey, NotNull] public int    PersonID  { get; set; } // Long
		[Column,     NotNull] public string Diagnosis { get; set; } // VarChar(255)
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Access.OleDb.Doctor.PersonID), CanBeNull=true)]
		public Doctor PersonDoctor { get; set; }

		/// <summary>
		/// PersonPatient_BackReference (Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Access.OleDb.Patient.PersonID), CanBeNull=true)]
