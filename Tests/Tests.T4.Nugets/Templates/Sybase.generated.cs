...
namespace Sybase
{
	...
	public partial class Doctor
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Sybase.Person.PersonID), CanBeNull=false)]
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Sybase.Doctor.PersonID), CanBeNull=true)]
		public Doctor Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (dbo.Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Sybase.Patient.PersonID), CanBeNull=true)]
