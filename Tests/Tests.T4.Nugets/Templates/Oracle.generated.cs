...
namespace Oracle
{
	...
	public partial class CollatedTable
	{
		...
		[Column, NotNull] public string  CaseSensitive   { get; set; } // VARCHAR2(20)
		[Column, NotNull] public string  CaseInsensitive { get; set; } // VARCHAR2(20)
	}
	...
	public partial class Doctor
	{
		...
		[Column,     NotNull] public string  Taxonomy { get; set; } // NVARCHAR2(50)
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Oracle.Person.PersonID), CanBeNull=false)]
	...
	{
		[PrimaryKey, NotNull] public decimal PersonID  { get; set; } // NUMBER
		[Column,     NotNull] public string  Diagnosis { get; set; } // NVARCHAR2(256)
	...
	public partial class Person
	{
		...
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Oracle.Doctor.PersonID), CanBeNull=true)]
		public Doctor Doctor { get; set; }

		/// <summary>
		/// FK_Patient_Person_BackReference (MANAGED.Patient)
		/// </summary>
		[Association(ThisKey=nameof(PersonID), OtherKey=nameof(Oracle.Patient.PersonID), CanBeNull=true)]
	...
	public partial class StringTest
	{
		...
		[Column, NotNull    ] public string KeyValue     { get; set; } // VARCHAR2(50)
	}
