...
namespace Access.ODBC
{
	public partial class DataContextDB : LinqToDB.Data.DataConnection
	{
		#region Tables
		...
		public DataContextDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public DataContextDB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public DataContextDB(DataOptions<DataContextDB> options)
	...
	public static partial class DataContextDBStoredProcedures
	{
		#region PatientSelectByName

		public static IEnumerable<PatientSelectByNameResult> PatientSelectByName(this DataContextDB dataConnection, string @firstName, string @lastName)
		{
			var parameters = new []
			{
		...
		public static int PersonDelete(this DataContextDB dataConnection, int? @PersonID)
		{
			var parameters = new []
			{
		...
		public static int PersonInsert(this DataContextDB dataConnection, string @FirstName, string @MiddleName, string @LastName, string @Gender)
		{
			var parameters = new []
			{
				new DataParameter("@FirstName",  @FirstName,  LinqToDB.DataType.VarChar, 255),
		...
		public static IEnumerable<PersonSelectByKeyResult> PersonSelectByKey(this DataContextDB dataConnection, int? @id)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<PersonSelectByNameResult> PersonSelectByName(this DataContextDB dataConnection, string @firstName, string @lastName)
		{
			var parameters = new []
			{
				new DataParameter("@firstName", @firstName, LinqToDB.DataType.VarChar, 255),
		...
		public static IEnumerable<PersonSelectListByNameResult> PersonSelectListByName(this DataContextDB dataConnection, string @firstName, string @lastName)
		{
			var parameters = new []
			{
				new DataParameter("@firstName", @firstName, LinqToDB.DataType.VarChar, 255),
		...
		public static int PersonUpdate(this DataContextDB dataConnection, int? @id, int? @PersonID, string @FirstName, string @MiddleName, string @LastName, string @Gender)
		{
			var parameters = new []
			{
				new DataParameter("@id",         @id,         LinqToDB.DataType.Int32),
