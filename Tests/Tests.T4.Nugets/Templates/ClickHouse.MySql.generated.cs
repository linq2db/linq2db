...
namespace ClickHouse.MySql
{
	public partial class Testdb3DB : LinqToDB.Data.DataConnection
	{
		#region Tables
		...
		public Testdb3DB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Testdb3DB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Testdb3DB(DataOptions<Testdb3DB> options)
