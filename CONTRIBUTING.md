...
* [Azure Pipelines](https://dev.azure.com/linq2db/linq2db/_build?definitionId=1) [pipelines/default.yml](https://github.com/linq2db/linq2db/blob/master/Build/Azure/pipelines/default.yml).
