...
FOR %%n IN (linq2db linq2db.Extensions linq2db.Compat linq2db.Tools linq2db.Scaffold linq2db.Remote.Grpc linq2db.Remote.Wcf linq2db.FSharp linq2db.EntityFrameworkCore.v3 linq2db.EntityFrameworkCore.v8 linq2db.EntityFrameworkCore.v9) DO (
